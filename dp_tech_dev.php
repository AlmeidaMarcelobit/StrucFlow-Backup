...
<main>
    ...
    <article>
        ...
        <div class="colaborador-info">
            <div class="colaborador-img"><img src="foto_colaboradores/Gabriel%20Dourado.jpeg" alt="Foto de Gabriel Dourado" class="foto"></div>
    ...
    <article>
        <h2>DADOS DO COLABORADOR</h2>
        <div class="colaborador-info">
            <div class="colaborador-img"><img src="foto_colaboradores/Fabio%20Manoel%20Goncalves%20D'Avilla.jpeg" alt="Foto de Fabio Manoel Goncalves D'Avilla" class="foto"></div>
            <div class="colaborador-details">
    ...
    <article>
        <h2>DADOS DO COLABORADOR</h2>
        <div class="colaborador-info">
            <div class="colaborador-img"><img src="foto_colaboradores/SEM%20FOTO.jpg" alt="Foto de Bianca Naomi de Carvalho" class="foto"></div>
            <div class="colaborador-details">
    ...
    <article>
        <h2>DADOS DO COLABORADOR</h2>
        <div class="colaborador-info">
            <div class="colaborador-img"><img src="foto_colaboradores/Ana%20Beatriz%20Melo%20Silveir.jpeg" alt="Foto de Ana Beatriz Melo Silveira" class="foto"></div>
            <div class="colaborador-details">
    ...
    <article>
        <h2>DADOS DO COLABORADOR</h2>
        <div class="colaborador-info">
            <div class="colaborador-img"><img src="foto_colaboradores/Allan%20Magrini.jpeg" alt="Foto de Allan Magrini" class="foto"></div>
            <div class="colaborador-details">
    ...
    <article>
        <h2>Dados do colaborador</h2>
        <div class="colaborador-info">
            <div class="colaborador-img"><img src="foto_colaboradores/SEM%20FOTO.jpg" alt="Foto de Daniel Braz" class="foto"></div>
            <section>
                <div>
    ...
    <article>
        ...
        <section class="colaborador-info">
            <div><img src="foto_colaboradores/Lucas%20Ramalho.jpeg" alt="foto de Lucas Claudino de Oliveira Ramalho" class="foto"></div>
            <div class="colaborador-details">
