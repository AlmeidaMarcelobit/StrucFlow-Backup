...
<article>
    ...
    <div class="colaborador-info">
        <div class="colaborador-img">
            <img
                src="foto_colaboradores/gabriel_dourado.jpg"
                alt="Foto de Gabriel Dourado"
                class="foto"
            />
        </div>
    ...
    <section class="ticket">
        ...
        <article>
            ...
            <div class="colaborador-info">
                <div class="colaborador-img">
                    <img
                        src="foto_colaboradores/fabio_manoel_goncalves_davilla.jpg"
                        alt="Foto de Fabio Manoel Goncalves D'Avilla"
                        class="foto" />
                </div>
                <div class="colaborador-details">
        ...
        <article>
            ...
            <div class="colaborador-info">
                <div class="colaborador-img">
                    <img
                        src="foto_colaboradores/bianca_naomi_carvalho.jpg"
                        alt="Foto de Bianca Naomi de Carvalho"
                        class="foto" />
                </div>
                <div class="colaborador-details">
        ...
        <article>
            ...
            <div class="colaborador-info">
                <div class="colaborador-img">
                    <img
                        src="foto_colaboradores/ana_beatriz_silveira.jpg"
                        alt="Foto de Ana Beatriz Melo Silveira"
                        class="foto" />
                </div>
                <div class="colaborador-details">
        ...
        <article>
            ...
            <div class="colaborador-info">
                <div class="colaborador-img">
                    <img
                        src="foto_colaboradores/allan_magrini.jpg"
                        alt="Foto de Allan Magrini"
                        class="foto" />
                </div>
                <div class="colaborador-details">
        ...
        <article>
            ...
            <div class="colaborador-img">
                    <img
                        src="foto_colaboradores/Daniel Braz.jpg"
                        alt="Foto de Daniel Braz"
                        class="foto" />
                </div>
            <section>
                <div>
