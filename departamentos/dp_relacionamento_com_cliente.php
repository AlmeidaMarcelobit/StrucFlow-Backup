...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Relacionamento com Cliente</title>
    </head>
        ...
        <main>
            ...
            <article>
                ...
                <section class="colaborador-info">
                    <div><img src="../foto_colaboradores/SEM FOTO.jpg" alt="foto de Raissa MArtins de Lima"
                            class="foto"></div>
                    <div class="colaborador-details">
                        <p><strong>Colaborador:</strong>Raíssa Martins de Lima</p>
                        <p><strong>Email:</strong>raissa.lima@amorsaude.com</p>
            ...
            <article>
                <h2>Dados do colaborador</h2>
                <section class="colaborador-info">
                    <div><img src="../foto_colaboradores/SEM FOTO.jpg" alt="foto de Dayane Cristina Silva dos Santos"
                            class="foto"></div>
                    <div class="colaborador-details">
