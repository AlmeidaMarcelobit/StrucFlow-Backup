        ...
        <article class="colaborador-verificar">
            ...
            <div class="colaborador-info">
                ...
                <div class="colaborador-details">
                    ...
                    <p><strong>Email:</strong> daniel.vieira@amorsaude.com
                    </p>
                    <p><strong>Cargo:</strong> Chief People and Culture Officer
                    </p>
            ...
            <div class="equipamentos-info">
                ...
                <div class="equipamento">
                    ...
                    <p class="serial"><strong>S/N:</strong> 2320CE1626B8 - 2316LZX3GDV8
                    </p>
                ...
                <div class="equipamento">
                    <p><strong>Tipo:</strong> Notebook Win-11 i7-1255u 16GB
                    </p>
        ...
        <article class="colaborador-verificar">
            ...
            <div class="colaborador-info">
                ...
                <div class="colaborador-details">
                    ...
                    <p><strong>Cargo: </strong>Assistente de Pessoas & Cultura
                    </p>
            ...
            <div class="equipamentos-info">
                ...
                <div class="equipamento">
                    ...
                    <p class="serial"><strong>S/N: </strong>2232CE1D0228 - 2230DLZX3BNW8
                    </p>
                ...
                <div class="equipamento">
                    ...
                    <p><strong>IMEI:</strong> 352800824097718 32800824097726
                    </p>
                </div>
                <div class="equipamento">
        ...
        <article>
            ...
            <div class="colaborador-info">
                ...
                <div class="colaborador-details">
                    ...
                    <p><strong>Email:
                            </strong>leandro.montenegro@amorsaude.com</p>
                    <p><strong>Cargo: </strong>Analista de Pessoas & Cultura Júnior
                    </p>
                    <p><strong>Departamento: </strong>Pessoas & Cultura</p>
                    <p><strong>CPF: </strong>385.498.628-94</p>
                    <p><strong>Data da Entrada: </strong>4.março.-2024</p>
                    <p><strong>Centro de Custo: </strong>13006 - Pessoas & Cultura
                    </p>
            ...
            <div class="equipamentos-info">
                <div class="equipamento">
                    ...
                    <p><strong>Marca/Modelo: </strong>Dell Vostro 15 3510
                    </p>
                </div>
                <div class="equipamento">
                    <p><strong>Tipo: </strong>Fone</p>
        ...
        <article class="colaborador-verificar">
            ...
            <div class="colaborador-info">
                ...
                <div class="colaborador-details">
                    ...
                    <p><strong>Termo de Entrega do Equipamento: </strong><a target="_blank" href="https://drive.google.com/file/d/17JQsopkgI79tGkk1N8o4Q__szryDzMmJ/view?usp=sharing">Termo
                                01</a></p>
        ...
        <article>
            ...
            <div class="colaborador-info">
                ...
                <div class="colaborador-details">
                    ...
                    <p><strong>Termo de Entrega do Equipamento: </strong><a target="_blank" href="https://drive.google.com/file/d/16eRbIG0gkx9jsTtTQmuOqZ9nFbFFaUC8/view?usp=sharing">Termo
        ...
        <article class="colaborador-verificar">
            ...
            <div class="colaborador-info">
                ...
                <div class="colaborador-details">
                    ...
                    <p><strong>Email:
                                </strong>wendell.oliveira@amorsaude.com</p>
                    <p><strong>Cargo: </strong>Analista de Pessoas & Cultura Sênior</p>
                    <p><strong>Departamento: </strong>Pessoas & Cultura
                    </p>
                    <p><strong>CPF: </strong>411.412.878-62</p>
                    <p><strong>Data da Entrada:
                                </strong>4.março.-2024</p>
            ...
            <div class="equipamentos-info">
                <div class="equipamento">
                    ...
                    <p><strong>Marca/Modelo: </strong>Dell Vostro 3520
                    </p>
                </div>
                <div class="equipamento">
                    <p><strong>Tipo: </strong>Fone</p>
        ...
        <article class="colaborador-verificar">
            ...
            <div class="equipamentos-info">
                ...
                <div class="equipamento">
                    ...
                    <p><strong>Marca/Modelo: </strong>Multilaser MO300
                    </p>
                </div>
                <div class="equipamento">
        ...
        <article class="colaborador-verificar">
            ...
            <div class="colaborador-info">
                ...
                <div class="colaborador-details">
                    ...
                    <p><strong>Email:
                                    </strong>ana.bujardi@amorsaude.com</p>
            ...
            <div class="equipamentos-info">
                ...
                <div class="equipamento">
                    ...
                    <p class="serial"><strong>S/N:
                                    </strong>2330AY031F68</p>
                    <p><strong>Marca/Modelo: </strong>Logitech H390
                    </p>
                </div>
                <div class="equipamento">
                    <p><strong>Tipo: </strong>Teclado e Mouse</p>
                    ...
                    <p><strong>Marca/Modelo: </strong>Logitech MK270
                    </p>
                </div>
                <div class="equipamento">
                    <p><strong>Tipo: </strong>Monitor</p>
                    ...
                    <p class="serial"><strong>S/N:
                                    </strong>302AZDB7F874</p>
                    <p><strong>Marca/Modelo: </strong>LG 22MP410-B
                    </p>
                </div>
                <div class="equipamento">
                    <p><strong>Tipo: </strong>Suporte</p>
