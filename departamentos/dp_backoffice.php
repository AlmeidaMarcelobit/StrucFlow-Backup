...
<main>
  <header class="ativo">
    <h1>COLABORADORES ATIVOS</h1>
        ...
        <div class="colaborador-info">
            ...
            <div class="colaborador-details">
                <p><strong>Colaborador:</strong>Marjorie Rodrigues</p>
        ...
        <div class="colaborador-info">
            ...
            <div class="colaborador-details">
                <p><strong>Colaborador:</strong>Larissa Ribeiro</p>
        ...
        <div class="colaborador-info">
            ...
            <div class="colaborador-details">
                <p><strong>Colaborador:</strong>Cauã Bacilieri</p>
    ...
    <article>
        ...
        <div class="colaborador-info">
            ...
            <div class="colaborador-details">
                ...
                <p><strong>Colaborador:</strong>Carlos Cunis</p>
                <p><strong>Email:</strong>carlos.cunis@amorsaude.com</p>
                <p><strong>Cargo:</strong>Analista De Treinamentos</p>
                <p><strong>Departamento:</strong>BackOffice</p>
                <p><strong>CPF:</strong></p>
                <p><strong>Data da admissão:</strong></p>
  ...
  <article>
    <h2>DADOS DO COLABORADOR</h2>
    <div class="colaborador-info">
      <div class="colaborador-img"><img src="../foto_colaboradores/Nicholas Esdras Lopes.jpeg" alt="Foto de Nicholas Esdras Lopes" class="foto"></div>
      <div class="colaborador-details">
  ...
  <article>
    ...
    <section class="colaborador-info">
      <div class="colaborador-img"><img src="../foto_colaboradores/Cauã Bacileri.jpeg" alt="Foto de Nicholas Esdras Lopes" class="foto"></div>
      <div class="colaborador-details">
  ...
  <article>
    <h2>Dados do colaborador</h2>
    <section class="colaborador-info">
      <div><img src="../foto_colaboradores/Sophia Fantini.jpeg" alt="Foto Sophia Vieira Fantini" class="foto"></div>
      <div class="colaborador-details">
        <p><strong>Colaborador:</strong>Sophia Vieira Fantini</p>
        <p><strong>Email:</strong>sophia.fantini@amorsaude.com</p>
        <p><strong>Cargo:</strong>Estagiário</p>
  ...
  <article>
    <h2>Dados do colaborador</h2>
    <section class="colaborador-info">
      <div><img class="foto" src="../foto_colaboradores/Ana Fumagalli.jpeg" alt="foto de Ana Luisa Rezende Machado Fumagalli"></div>
      <div class="colaborador-details">
        <p><strong>Colaborador:</strong>Ana Luisa Rezende Machado Fumagalli</p>
        <p><strong>Email:</strong>analuisa.fumagalli@amorsaude.com</p>
  ...
  <article>
    <h2>Dados do colaborador</h2>
    <section class="colaborador-info">
      <div><img class="foto" src="../foto_colaboradores/Fernanda Espadari.jpeg" alt="foto de Fernanda Radiguieri Espadari "></div>
      <div class="colaborador-details">
  ...
  <article>
    <h2>Dados do colaborador</h2>
    <section class="colaborador-info">
      <div><img src="../foto_colaboradores/Carlos Cunis.jpeg" alt="foto de Carlos Cunis Pereira" class="foto"></div>
      <div class="colaborador-details">
    ...
    <section class="equipamentos-info">
      ...
      <div class="equipamento">
        ...
        <strong>Marca/Modelo:</strong>Lenovo Inspiron3501p90f</p>
        <p class="serial"><strong>S/N:</strong>2332ME01XKV8</p>
      </div>
      <div class="equipamento">
        <p><strong>Tipo:</strong>Celular</p>
  ...
  <article>
    <h2>Dados do colaborador</h2>
    <section class="colaborador-info">
      <div><img class="foto" src="../foto_colaboradores/Marjorie Caetano Rodrigues.jpeg" alt="foto de Marjorie Caetano Rodrigues"></div>
      <div class="colaborador-details">
    ...
    <section class="equipamentos-info">
      <div class="equipamento">
        ...
        <p class="serial"><strong>S/N:</strong>96w2d3</p>
        <p><strong>Patrimônio:</strong>27</p>
      </div>
    </section>
  </article>
  <article>
    <h2>Dados do colaborador</h2>
    <section class="colaborador-info">
      <div><img class="foto" src="../foto_colaboradores/Pedro Henrique Romano Caetano.jpeg" alt="foto de Pedro Henrique Romano Caetano"></div>
      <div class="colaborador-details">
        <p><strong>Colaborador:</strong>Pedro Henrique Romano Caetano</p>
        <p><strong>Email:</strong>pedro.caetano@amorsaude.com</p>
        <p><strong>Cargo:</strong>Analista De Processos Jr</p>
  ...
  <article>
    <h2>Dados do colaborador</h2>
    <section class="colaborador-info">
      <div><img src="../foto_colaboradores/Nicolas Tassinari.jpeg" alt="foto de Nicolas Tassinari" class="foto"></div>
      <div class="colaborador-details">
  ...
  <article>
    <h2>Dados do colaborador</h2>
    <section class="colaborador-info">
      <div><img class="foto" src="../foto_colaboradores/Lethicia Eliane Souza Martins.jpeg" alt="foto de Lethicia Eliane Souza Martins"></div>
      <div class="colaborador-details">
  ...
  <article>
    <h2>DADOS DO COLABORADOR</h2>
    <div class="colaborador-info">
      <div class="colaborador-img"><img src="../foto_colaboradores/Larissa Branco Ribeiro.jpeg" alt="Foto de Larissa Branco Ribeiro" class="foto"></div>
      <div class="colaborador-details">
    ...
    <section class="ticket">
      ...
      <p><strong>Equipamentos:</strong>Teclado e Mouse, Notebook, Monitor, Suporte, Adaptador de Rede, Fone</p>
    </section>
  </article>
  ...
  <article>
    <h2>Dados do colaborador</h2>
    <section class="colaborador-info">
      <div class="colaborador-img"><img class="foto" src="../foto_colaboradores/Yasmin Silva.jpeg" alt="Foto do Yasmin Campos da Silva"></div>
      <div class="colaborador-details">
  ...
  <article>
    <h2>Dados do colaborador</h2>
    <section class="colaborador-info">
      <div class="colaborador-img"><img class="foto" src="../foto_colaboradores/Helena Bugliani.jpeg" alt="Foto do Helena Silva Bugliani"></div>
      <div class="colaborador-details">
  ...
  <article>
    <h2>DADOS DO COLABORADOR</h2>
    <div class="colaborador-info">
      <div class="colaborador-img"><img src="../foto_colaboradores/Bianca Inácio.jpeg" alt="Foto de Bianca Inacia da Silva" class="foto"></div>
      <div class="colaborador-details">
  ...
  <article>
    <h2>DADOS DO COLABORADOR</h2>
    <div class="colaborador-info">
      <div class="colaborador-img"><img src="../foto_colaboradores/Tatiane Zeotti.jpeg" alt="Foto de Tatiane Zeotti" class="foto"></div>
      <div class="colaborador-details">
