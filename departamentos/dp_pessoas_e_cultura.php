    ...
    <body>
        ...
        <div class="colaborador-info">
            ...
            <article>
                <h2>DADOS DO COLABORADOR</h2>
                <div class="colaborador-info">
                    <div class="colaborador-img"> <img src="../foto_colaboradores"
                            alt="Foto de Beatriz Olive Pinho Moreira" class="foto"> </div>
                    <div class="colaborador-details">
            ...
            <article>
                ...
                <section class="colaborador-info">
                    <div class="colaborador-img"><img class="foto" src="../foto_colaboradores/Daniel Vieira.jpeg"
                            alt="Foto do Daniel Vieira"></div>
                    <div class="colaborador-details">
            ...
            <article>
                <h2>DADOS DO COLABORADOR</h2>
                <section class="colaborador-info">
                    <div class="colaborador-img"><img src="../foto_colaboradores/Lara Alves de Souz.jpeg"
                            alt="Foto de Lara Alves de Souza" class="foto"></div>
                    <div class="colaborador-details">
            ...
            <article>
                <h2>DADOS DO COLABORADOR</h2>
                <section class="colaborador-info">
                    <div class="colaborador-img"><img src="../foto_colaboradores/Ana Almeida.jfif"
                            alt="Foto de Ana Clara Lourenço de Almeida" class="foto"></div>
                    <div class="colaborador-details">
            ...
            <article>
                <h2>DADOS DO COLABORADOR</h2>
                <section class="colaborador-info">
                    <div class="colaborador-img"><img src="../foto_colaboradores/Iara Ribeiro.jfif"
                            alt="Foto de Iara Cristina Moraes Ribeiro" class="foto"></div>
                    <div class="colaborador-details">
            ...
            <article>
                <h2>DADOS DO COLABORADOR</h2>
                <section class="colaborador-info">
                    <div class="colaborador-img"><img src="../foto_colaboradores/Leticia Silva.jfif"
                            alt="Foto de Letícia Godoy da Silva" class="foto"></div>
                    <div class="colaborador-details">
            ...
            <article>
                <h2>DADOS DO COLABORADOR</h2>
                <section class="colaborador-info">
                    <div class="colaborador-img"><img src="../foto_colaboradores/Ana Julia Bujardi.jfif"
                            alt="Foto de Letícia Godoy da Silva" class="foto"></div>
                    <div class="colaborador-details">
            ...
            <article>
                <h2>Dados do colaborador</h2>
                <section class="colaborador-info">
                    <div><img src="../foto_colaboradores/Edmar de Almeida.jpeg" alt="foto de Edmar de Almeida"
                            class="foto"></div>
                    <div class="colaborador-details">
        ...
        <div class="colaborador-info">
            ...
            <article>
                <h2>DADOS DO COLABORADOR</h2>
                <div class="colaborador-info">
                    <div class="colaborador-img"> <img src="../foto_colaboradores" alt="Foto de Bianca Festucci Duzzi"
                            class="foto"> </div>
                    <div class="colaborador-details">
            ...
            <article>
                <h2>DADOS DO COLABORADOR</h2>
                <section class="colaborador-info">
                    <div class="colaborador-img"><img src="../foto_colaboradores/Wendell Oliveira.jfif"
                            alt="Foto de Wendell Alessandro Candido Oliveira" class="foto"></div>
                    <div class="colaborador-details">
            ...
            <article>
                <h2>Dados do colaborador</h2>
                <section class="colaborador-info">
                    <div class="colaborador-img"><img src="../foto_colaboradores/Sandra Oliveira.jpeg"
                            alt="Foto de Sandra Andreia de Oliveira" class="foto"></div>
                    <div class="colaborador-details">
            ...
            <article>
                <h2>DADOS DO COLABORADOR</h2>
                <section class="colaborador-info">
                    <div class="colaborador-img"><img src="../foto_colaboradores/Leandro Montenegro.jfif"
                            alt="Foto de Leandro Tosta Montenegro" class="foto"></div>
                    <div class="colaborador-details">
