		...
		<main>
			...
			<article>
				...
				<div class="colaborador-info">
					<div class="colaborador-img"><img src="../foto_colaboradores/Tamara Saturno.jpeg" alt="Foto de Tamara Honorato Saturno" class="foto"></div>
			...
			<article>
				<h2>DADOS DO COLABORADOR</h2>
				<div class="colaborador-info">
					<div class="colaborador-img"><img src="../foto_colaboradores/SEM FOTO.jpg" alt="Foto de Sandro Edvar Bizi" class="foto"></div>
					<div class="colaborador-details">
			...
			<article>
				<h2>DADOS DO COLABORADOR</h2>
				<div class="colaborador-info">
					<div class="colaborador-img"><img src="../foto_colaboradores/Rubem Diniz.jpeg" alt="Foto de Rubem Diniz" class="foto"></div>
					<div class="colaborador-details">
			...
			<article>
				<h2>DADOS DO COLABORADOR</h2>
				<div class="colaborador-info">
					<div class="colaborador-img"><img src="../foto_colaboradores/SEM FOTO.jpg" alt="Foto de Roger Ricobelo Mazzali" class="foto"></div>
					<div class="colaborador-details">
			...
			<article>
				<h2>DADOS DO COLABORADOR</h2>
				<div class="colaborador-info">
					<div class="colaborador-img"><img src="../foto_colaboradores/Marcelo Martins.jpeg" alt="Foto de Marcelo Martins" class="foto"></div>
					<div class="colaborador-details">
			...
			<article>
				<h2>DADOS DO COLABORADOR</h2>
				<div class="colaborador-info">
					<div class="colaborador-img"><img src="../foto_colaboradores/Fabio Rafael.jpeg" alt="" class="foto"></div>
					<div class="colaborador-details">
			...
			<article>
				<h2>DADOS DO COLABORADOR</h2>
				<div class="colaborador-info">
					<div class="colaborador-img"><img src="../foto_colaboradores/SEM FOTO.jpg" alt="" class="foto"></div>
					<div class="colaborador-details">
			...
			<article>
				<h2>DADOS DO COLABORADOR</h2>
				<div class="colaborador-info">
					<div class="colaborador-img"><img src="../foto_colaboradores/Caio Souza.jpeg" alt="" class="foto"></div>
					<div class="colaborador-details">
