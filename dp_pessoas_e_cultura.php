...
<main>
    ...
    <article>
        ...
        <section class="colaborador-info">
            <div class="colaborador-img">
                <img class="foto" src="foto_colaboradores/Daniel%20Vieira.png" alt="Foto do Daniel Vieira"></div>
    ...
    <article>
        <h2>DADOS DO COLABORADOR</h2>
        <section class="colaborador-info">
            <div class="colaborador-img"><img src="foto_colaboradores/" alt="Foto de Lara Alves de Souza" class="foto"></div>
            <div class="colaborador-details">
