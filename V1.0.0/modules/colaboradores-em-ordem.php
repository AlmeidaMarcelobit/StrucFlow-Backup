...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Bruna de Freitas Rosário</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Carla Karolaine Da Costa Silvestre Silva</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Cauã Fernando Bacilieri Silva</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Cinthia Cristiane Alexandre Viana</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Davi Ribeiro da Silva</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Diego Alberto Rodrigues Blandino</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Ed Carlos Pasquini</p>
...
<article>
                <section class="colaborador-info">
                    <div><img src="../assents/fotos/foto_colaboradores/Junior%20Ortolan.jpg" alt="" class="foto"></div>
                    <div class="colaborador-details">
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Emanuela Feteira Santos</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Felipe Lemes Fernandes</p>
...
<article class="redflag">
    <section class="colaborador-info">
        <div>
            <img src="" alt="Foto de "" class=" foto="" />
        </div>
        <div class=" colaborador-details">
            <p><strong>Colaborador:</strong>Franciele Tavares</p>
        </div>
    </section>
</article>
<article>
...
<article>
    <section class=colaborador-info>
        ...
        <div class=colaborador-details>
            <p><strong>Colaborador:</strong>Gabriel Borges Silverio</p>
            <p><strong>Email:</strong></p>
    ...
    <section class=equipamentos-info>
        <div class=equipamento>
            <p><strong>Tipo:</strong>Notebook</p>
            <p><strong>Marca/Modelo:</strong>Inspiron3501 P90F</p>
        ...
        <div class=equipamento>
            <p><strong>Tipo:</strong>Celuklar</p>
            <p><strong>Marca/Modelo:</strong>Galaxy A03</p>
            <p class=serial><strong>S/N:</strong>R9XT700F6NK</p>
            <p><strong>Patrimônio:</strong>582</p>
        ...
        <div class=equipamento>
            <p><strong>Tipo:</strong>Monitor</p>
            <p><strong>Marca/Modelo:</strong>Dell O2018HC</p>
            <p class=serial><strong>S/N:</strong>CB6H9Q2</p>
            <p><strong>Patrimônio:</strong>20</p>
        </div>
    </section>
    <section class=ticket>
        <p><strong>ID Ticket:</strong>N/A</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Laura Barros Ribeiro</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Lauriele Santiago dos Santos</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Leandro Rodrigues Santos</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            ...
            <p><strong>Colaborador:</strong>Lucas Rodrigues Alcassa</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Marcelo Alexandre Barbosa Martins</p>
...
<article>
                <section class="colaborador-info">
                    <div><img src="../assents/fotos/foto_colaboradores/Sem%20Foto.jpg" alt="foto de Miria Elisiane Cardoso" class="foto"></div>
                    <div class="colaborador-details">
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Murillo Flavio Zanine</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Nicholas Esdras Lopes dos Santos</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Paula Aparecida Tagliacolli</p>
...
<article>
    <section class=colaborador-info>
        ...
        <div class=colaborador-details>
            <p><strong>Colaborador:</strong>Paulo Joneas Goncalves Rick</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong> Pedro Henrique Castelani Dias Pires do Prado</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Rogerio Santos de Almeida</p>
...
<article>
    ...
    <section class="equipamentos-info">
        ...
        <div class="equipamento">
            <p><strong>Tipo:</strong>Celular</p>
            <p><strong>Marca/Modelo:</strong>Galaxy A02</p>
            <p class="serial"><strong>S/N:</strong>RX9R90HDAAR</p>
            <p><strong>Patrimonio:</strong>794</p>
...
<article>
    <section class="colaborador-info">
        ...
        <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Yago Romao Rocha Oliveira</p>
