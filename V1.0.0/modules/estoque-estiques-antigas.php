...
<body>
    <header id="cabeca"><img src="../assents/logo/logo-semfundo.png" alt="LOGO AMORSAUDE"> <?php include '../includes/header.html';?> </header>
    <main>
        <div class="container">
            <header class="workpack" id="workpack">
                <h1>KITS A PREPARAR</h1>
            </header>

            <article>
                <section class="colaborador-info">
                    <div><img src="../foto_colaboradores" alt="Foto de Marcos Vinicius Baleirini Silva" class="foto"></div>
                    <div class="colaborador-details">
                        <p><strong>Colaborador:</strong>Marcos Vinicius Baleirini Silva</p>
                        ...
                        <p><strong>Data da admissão:</strong>03.02.2025</p>
                        <p><strong>Data da desligamento:</strong></p>
                        <p><strong>Centro de Custo:</strong>33007 - Clientes</p>
                    </div>
                </section>
                ...
                <section class="ticket">
                    <p><strong>Equipamentos:</strong>Notebook 8GB, Teclado e Mouse, Celular, Monitor</p>
                </section>
            </article>
            <article>
                <section class="colaborador-info">
                    <div><img src="../foto_colaboradores" alt="Foto de Bruna Alitéia de Souza Branco" class="foto"></div>
                    <div class="colaborador-details">
                        <p><strong>Colaborador:</strong>Bruna Alitéia de Souza Branco</p>
                        <p><strong>Email:</strong></p>
                        <p><strong>Cargo:</strong>Analista de Parcerias Comerciais SR</p>
                        <p><strong>Departamento:</strong>Parcerias Comerciais</p>
                ...
                <section class="ticket">
                    <p><strong>ID Ticket:</strong>#119805</p>
                    <p><strong>Equipamentos:</strong>Notebook 8GB, Suporte, Teclado e Mouse, Celular, Monitor</p>
                </section>
            </article>
            <article>
                <section class="colaborador-info">
                    <div><img src="../foto_colaboradores" alt="Foto de Jocasta Pires" class="foto"></div>
                    <div class="colaborador-details">
                        <p><strong>Colaborador:</strong>Jocasta Pires</p>
                        <p><strong>Email:</strong></p>
                ...
                <section class="ticket">
                    <p><strong>ID Ticket:</strong>#119804</p>
                    <p><strong>Equipamentos:</strong>Notebook 8GB, Suporte, Teclado e Mouse, Celular, Monitor</p>
                </section>
            </article>
            <header class="workpack" id="workpack">
            ...
            <article>
                <section class="colaborador-info">
                    <div class="colaborador-details">
                        ...
                        <p><strong>ID Caixa Antiga:</strong>106</p>
            ...
            <article>
                <section class="colaborador-info">
                    <div class="colaborador-details">
                        ...
                        <p><strong>ID Caixa Antiga:</strong>110</p>
            ...
            <article>
                <section class="colaborador-info">
                    <div class="colaborador-details">
                        ...
                        <p><strong>ID Caixa Antiga:</strong>03</p>
            ...
            <article>
                <section class="colaborador-info">
                    <div class="colaborador-details">
                        ...
                        <p><strong>ID Caixa Antiga:</strong>04</p>
            ...
            <article>
                <section class="colaborador-info">
                    <div class="colaborador-details">
                        ...
                        <p><strong>ID Caixa Antiga:</strong>108</p>
            ...
            <article>
                <section class="colaborador-info">
                    <div class="colaborador-details">
                        ...
                        <p><strong>ID Caixa Antiga:</strong>113</p>
                        <p><strong>Colaborador:</strong></p>
                        <p><strong>Departamento:</strong></p>
            ...
            <article>
                <section class="colaborador-info">
                    <div class="colaborador-details">
                        ...
                        <p><strong>ID Caixa Antiga:</strong>116</p>
                        <p><strong>Colaborador:</strong></p>
                        <p><strong>Email:</strong></p>
            ...
            <article>
                <section class="colaborador-info">
                    <div class="colaborador-details">
                        ...
                        <p><strong>ID Caixa Antiga:</strong>117</p>
                        <p><strong>Colaborador:</strong></p>
                        <p><strong>Email:</strong></p>
            ...
            <article>
                <section class="colaborador-info">
                    <div class="colaborador-details">
                        ...
                        <p><strong>ID Caixa Antiga:</strong>120</p>
                        <p><strong>Colaborador:</strong></p>
                        <p><strong>Email:</strong></p>
            ...
            <article id="redflag">
                <section class="colaborador-info">
                    <div class="colaborador-details">
                        ...
                        <p><strong>ID Caixa Antiga:</strong>119</p>
                        <p><strong>Colaborador:</strong>Enzo Siqueira</p>
                        <p><strong>Email:</strong>enzo.siqueira@amorsaude.com</p>
                        <p><strong>Cargo:</strong></p>
                        <p><strong>Departamento:</strong></p>
                        <p><strong>CPF:</strong></p>
                        <p><strong>Data de admissão:</strong></p>
            ...
            <article>
                ...
                <section class="ticket">
                    <p><strong>ID Ticket:</strong>N/A</p>
                    <p><strong>Equipamentos:</strong>Suporte, Teclado e Mouse, Fone, Notebook Win-11 i7-1165G7 16GB</p>
                </section>
            </article>
            <article>
                <section class="colaborador-info">
