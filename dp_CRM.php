...
<main>
    ...
    <article>
        ...
        <section class="colaborador-info">
            <div class="colaborador-img"><img src="foto_colaboradores/Alexy Divino.jpeg" alt="Foto de Alexy Chiodi Divino" class="foto"></div>
            <div class="colaborador-details">
                ...
                <p><strong>Departamento:</strong>Dir. Marketing</p>
    ...
    <article>
        <h2>DADOS DO COLABORADOR</h2>
        <section class="colaborador-info">
            <div class="colaborador-img"><img src="foto_colaboradores/Caique Picolo.jpeg" alt="Foto de Alexy Chiodi Divino" class="foto"></div>
            <div class="colaborador-details">
                ...
                <p><strong>Termo de Entrega de Equipamento:</strong><a target="_blank" href="https://drive.google.com/file/d/1o6JpGhLuYQC9FPnO7YjdhqXTiZB6yst4/view?usp=sharing">Termo 01</a><a href="https://drive.google.com/file/d/11tWZC7UqtQN0ra3wzalKim6Q7P3skMM6/view?usp=sharing"
    ...
    <article>
        <h2>DADOS DO COLABORADOR</h2>
        <section class="colaborador-info">
            <div class="colaborador-img"><img class="foto" src="foto_colaboradores/Victor Lima.jpeg" alt="Victor Lima"></div>
            <div class="colaborador-details">
        ...
        <section class="equipamentos-info">
            <div class="equipamento">
                <p><strong>Tipo:</strong>Teclado e Mouse</p>
                <p><strong>Patrimônio:</strong>1514</p>
            ...
            <div class="equipamento">
                ...
                <p><strong>Patrimônio:</strong>629</p>
                <p class="serial"><strong>S/N:</strong>00275336253</p>
                <p><strong>Marca/Modelo:</strong>Jabra HSC016</p>
            </div>
            <div class="equipamento">
                <p><strong>Tipo:</strong>Notebook</p>
                <p><strong>Patrimônio:</strong>235</p>
                <p class="serial"><strong>S/N:</strong>1JLQXW3</p>
                <p><strong>Marca/Modelo:</strong>Dell Vostro 15 3510</p>
            </div>
            <div class="equipamento">
                <p><strong>Tipo:</strong>Smartphone</p>
                <p><strong>Patrimônio:</strong>698</p>
                <p class="serial"><strong>S/N:</strong>r9xta0d3v7h</p>
                <p><strong>Marca/Modelo:</strong>Galaxy A03</p>
                <p><strong>IMEI 1:</strong>352081309576480/01</p>
                <p><strong>IMEI 2:</strong>357299759576488/01</p>
            </div>
        </section>
    ...
    <article>
        <h2>DADOS DO COLABORADOR</h2>
        <section class="colaborador-info">
            <div class="colaborador-img"><img class="foto" src="foto_colaboradores/Emanuela Santos.jpeg" alt="Emanuela Santos"></div>
            <div class="colaborador-details">
