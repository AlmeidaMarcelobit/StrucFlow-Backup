  ...
  <main>
    ...
    <article>
      ...
      <div class="colaborador-info">
        <div class="colaborador-img">
          <img
            src="foto_colaboradores/Nicholas%20Esdras%20Lopes.jpeg"
      ...
      <section class="equipamentos-info">
        ...
        <div class="equipamento">
          ...
          <p>
            <strong>IMEI: </strong>354985980107183/01<br />355106270107184/01
          </p>
    ...
    <article>
      ...
      <section class="colaborador-info">
        <div class="colaborador-img">
          <img
            src="foto_colaboradores/Cauã%20Bacileri.jpeg"
            alt="Foto de Nicholas Esdras Lopes"
            class="foto" />
        </div>
        <div class="colaborador-details">
    ...
    <article>
      ...
      <section class="colaborador-info">
        <div>
          <img src="foto_colaboradores/Sophia%20Fantini.jpeg" alt="Foto Sophia Vieira Fantini" class="foto">
        </div>
        <div class="colaborador-details">
    ...
    <article>
      ...
      <section class="colaborador-info">
        <div>
          <img class="foto" src="foto_colaboradores/Ana%20Fumagalli.jpeg" alt="foto de Ana Luisa Rezende Machado Fumagalli">
        </div>
        <div class="colaborador-details">
          <p>
            <strong>Colaborador: </strong>Ana Luisa Rezende Machado Fumagalli
          </p>
    ...
    <article>
      ...
      <section class="colaborador-info">
        <div>
          <img class="foto" src="foto_colaboradores/Fernanda%20Espadari.jpeg" alt="foto de Fernanda Radiguieri Espadari ">
        </div>
        <div class="colaborador-details">
    ...
    <article>
      ...
      <section class="colaborador-info">
        <div>
          <img src="foto_colaboradores/Carlos%20Cunis.jpeg" alt="foto de Carlos Cunis Pereira" class="foto">
        </div>
        <div class="colaborador-details">
    ...
    <article>
      ...
      <section class="colaborador-info">
        <div>
          <img class="foto" src="foto_colaboradores/Marjorie%20Caetano%20Rodrigues.jpeg" alt="foto de Marjorie Caetano Rodrigues">
        </div>
        <div class="colaborador-details">
    ...
    <article>
      ...
      <section class="colaborador-info">
        <div>
          <img class="foto" src="foto_colaboradores/Pedro%20Henrique%20Romano%20Caetano.jpeg" alt="foto de Pedro Henrique Romano Caetano">
        </div>
        <div class="colaborador-details">
    ...
    <article>
      ...
      <section class="colaborador-info">
        <div>
          <img src="foto_colaboradores/Nicolas%20Tassinari.jpeg" alt="foto de Nicolas Tassinari" class="foto">
        </div>
        <div class="colaborador-details">
    ...
    <article>
      ...
      <section class="colaborador-info">
        <div>
          <img class="foto" src="foto_colaboradores/Lethicia%20Eliane%20Souza%20Martins.jpeg" alt="foto de Lethicia Eliane Souza Martins">
        </div>
        <div class="colaborador-details">
      ...
      <section class="equipamentos-info">
        <div class="equipamento">
          ...
          <p class="serial">
            <strong>S/N: </strong>224CE257B59<br />2241LZX1ULS8
          </p>
    ...
    <article>
      ...
      <div class="colaborador-info">
        <div class="colaborador-img">
          <img
            src="foto_colaboradores/Larissa Branco Ribeiro.jpeg"
            alt="Foto de Larissa Branco Ribeiro"
            class="foto" />
        </div>
        <div class="colaborador-details">
