...
<main>
    ...
    <article>
        ...
        <section class="equipamentos-info">
            ...
            <div class="equipamento">
                ...
                <p><strong>Marca/Modelo:</strong>Logitech MK270</p>
                <p class="serial">
                    <strong>S/N:</strong>2344LZXBR3M8 - 2347CE267DC8
                </p>
    ...
    <article>
        ...
        <section class="equipamentos-info">
            <div class="equipamento">
                ...
                <p><strong>Marca/Modelo:</strong>Lenovo V15 G3 IAP</p>
                <p class="serial">
                    <strong>S/N:</strong>PE9012326044-82UM0007BR-PE0CB4ZP
                </p>
            ...
            <div class="equipamento">
                ...
                <p><strong>Marca/Modelo:</strong>Logitech MK270</p>
                <p class="serial">
                    <strong>S/N:</strong>2347CE268038 - 2344LZXBR4M8
                </p>
    ...
    <article>
        ...
        <section class="equipamentos-info">
            <div class="equipamento">
                ...
                <p><strong>Marca/Modelo:</strong>Lenovo V15 G3 IAP</p>
                <p class="serial">
                    <strong>S/N:</strong>PE9014216040-82UM0007BR-PE0C2WXT
                </p>
            ...
            <div class="equipamento">
                ...
                <p><strong>Marca/Modelo:</strong>Logitech MK270</p>
                <p class="serial">
                    <strong>S/N:</strong>2320CE1626C8 - 2240LZN1KF18
                </p>
    ...
    <article>
        ...
        <section class="colaborador-info">
            <div class="colaborador-details">
                ...
                <p>
                    <strong>Colaborador:</strong>Lucas Claudino de Oliveira Ramalho
                </p>
                <p><strong>Email:</strong></p>
    ...
    <article>
        ...
        <section class="ticket">
            ...
            <p>
                ...
                notebook, Teclado e Mouse, Celular, Monitor extra
            </p>
        </section>
        <section class="obs">
    ...
    <article>
        ...
        <section class="ticket">
            ...
            <p>
                <strong>Equipamento:</strong>Headset, Mouse, Notebook 8G, Suporte
