...
<?php include 'departamentos/header.html';?>
<main>
    <header class="ativo">
    ...
    <article>
        <h2>Dados do colaborador</h2>
        <section class="colaborador-info">
            <div class="colaborador-img"><img src="foto_colaboradores/Paulo%20Victor%20Borges.jpeg" alt="Sem Foto" class="foto"></div>
            <div class="colaborador-details">
    ...
    <article>
        ...
        <div class="colaborador-info">
            <div class="colaborador-img"><img src="foto_colaboradores/Graziele Ambrosio.jpg" alt="foto Graziele Ambrosio " class="foto"></div>
            <div class="colaborador-details">
...
<?php include 'departamentos/footer.html'; ?>
</body>
</html>