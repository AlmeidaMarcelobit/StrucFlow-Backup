...
<div class="container">
    ...
    <div class="card"><img src="../imagem/Ana%20Caroline%20Alves.png" alt="foto de Ana Caroline de Rezende Alves"
        ...
        <div class="attention-info">
            ...
            <p><strong>Alerta:</strong>O colaborador está utilizando os equipamentos, porém ainda não possui o termo de
    ...
    <div class="card">
        ...
        <div class="attention-info">
            <h2>⚠️ Informações Importantes</h2>
            <p><strong>Alerta:</strong> O colaborador está utilizando os equipamentos listados, porém ainda não possui o
    ...
    <div class="card">
        ...
        <div class="attention-info">
            <h2>⚠️ Equipamentos Danificados</h2>
            <div class="device">
                <h4>🎧 Fone</h4>
                <p><strong>Patrimônio:</strong> 530</p>
