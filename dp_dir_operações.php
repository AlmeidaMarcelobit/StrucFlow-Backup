    ...
    <body>
        ...
        <div class="colaborador-info">
            ...
            <article>
                ...
                <div class="colaborador-info">
                    <div class="colaborador-img">
                        <img src="/foto_colaboradores" alt="Foto de Eduardo Cheade" class="foto">
                    </div>
                    <div class="colaborador-details">
            ...
            <article>
                ...
                <div class="colaborador-info">
                    ...
                    <div class="colaborador-details">
                        <p><strong>Colaborador:</strong>Beatriz Brisotti</p>
                        <p><strong>Email:</strong>beatriz.brisotti@amorsaude.com</p>
                        <p><strong>Cargo:</strong>Chief Operating Officer</p>
                        <p><strong>Departamento:</strong>Dir. Operações</p>
                        <p><strong>CPF:</strong></p>
                        <p><strong>Data da admissão:</strong></p>
                        <p><strong>Data da desligamento:</strong></p>
                        <p><strong>Centro de Custo:</strong>12000</p>
                    </div>
                </div>
            </article>
            <article>
            ...
            <article>
                ...
                <div class="colaborador-info">
                    <div class="colaborador-img">
                        <img src="foto_colaboradores/beatriz_chaves.jpg" alt="Foto de Beatriz Santo Chaves"
                            class="foto" />
                    </div>
                    <div class="colaborador-details">
                ...
                <section class="ticket">
                    ...
                    <p><strong>Equipamentos:</strong> Fone, Suporte, Teclado e Mouse, Notebook, Celular, Adaptador de
                        Rede</p>
                </section>
            </article>
