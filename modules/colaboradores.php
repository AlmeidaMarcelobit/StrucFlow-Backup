...
<body>
  <header id="cabeca">
    <img alt="LOGO AMORSAUDE" src="../assents/logo.jpeg" />
  ...
  <main class="container">
    <div class="container-article">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../assents/fotos/foto_colaboradores/Marianne%20Lesur%20Goncalves.jfif" alt="foto de Marianne Lesur Goncalves" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Daila Santos.jfif" alt="foto de Daila de Souza Silva Santos" class="foto"></div>
          <div class="colaborador-details">
        ...
        <section class="ticket">
          ...
          <p><strong>Equipamento:</strong>Monitor, Headset, Mouse, Notebook 8G, Suporte para notebook,
            Teclado</p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/SEM FOTO.jpg" alt="Foto de Elton Severo"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Marcos Correa</p>
            <p><strong>Email:</strong>marcos.correa@amorsaude.com</p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Tamara Saturno.jpeg" alt="Foto de Tamara Honorato Saturno" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/SEM FOTO.jpg" alt="Foto de Sandro Edvar Bizi" class="foto">
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Sandro Edvar Bizi</p>
            <p><strong>Email:</strong>sandro.bizi@amorsaude.com</p>
            <p><strong>Cargo:</strong>Gerente de Suporte</p>
            <p><strong>Departamento:</strong>Suporte</p>
            <p><strong>CPF:</strong>081.688.488-96</p>
            <p><strong>Data de admissão:</strong>16.09.2024</p>
            <p><strong>Data de desligamento:</strong>N/A</p>
            <p><strong>Centro de Custo:</strong>13019 - Suporte</p>
          </div>
        </section>
        <section class="equipamentos-info">
          <div class="equipamento">
            ...
            <p><strong>Patrimônio:</strong>473</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong>Logitech MK270</p>
            <p class="serial"><strong>Teclado S/N:</strong>2347CE267D78</p>
            <p class="serial"><strong>Mouse S/N:</strong>2344LZXBR5H8</p>
            <p><strong>Patrimônio:</strong>2015</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Fone</p>
            <p><strong>Marca/Modelo:</strong>Dell Wh1022</p>
            <p class="serial"><strong>S/N:</strong>VN-0RMH97-LXN00-43S-07L5-A01</p>
            <p><strong>Patrimônio:</strong>1032</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Suporte</p>
            <p><strong>Marca/Modelo:</strong>Alumínio</p>
            <p class="serial"><strong>S/N:</strong>N/A</p>
            <p><strong>Patrimônio:</strong>820</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Celular</p>
            <p><strong>Marca/Modelo:</strong>Motorola E13</p>
            <p class="serial"><strong>S/N:</strong>ZF5248DNZL</p>
            <p><strong>Patrimônio:</strong>1246</p>
            <p><strong>IMEI 1:</strong>354187776540152</p>
            <p><strong>IMEI 2:</strong>354187776540160</p>
          </div>
        </section>
        <section class="ticket">
          <p><strong>ID Ticket:</strong>#71347</p>
          <p><strong>Equipamentos:</strong>Teclado e Mouse, Notebook, Celular, Monitor, Suporte</p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Rubem Diniz.jpeg" alt="Foto de Rubem Diniz" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/SEM FOTO.jpg" alt="Foto de Roger Ricobelo Mazzali" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Marcelo Martins.jpeg" alt="Foto de Marcelo Martins" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/SEM FOTO.jpg" alt="" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Caio Souza.jpeg" alt="" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Thiago Isaac da Silva.jpeg" alt="foto de Thiago Isaac da Silva" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Renan Faganello</p>
            <p><strong>Email:</strong>renan.faganello@amorsaude.com</p>
            <p><strong>Cargo:</strong>Analista De Implantação Pl</p>
            <p><strong>Departamento:</strong></p>
            <p><strong>CPF:</strong></p>
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
            <p><strong>Centro de Custo:</strong>13013 - Produtos</p>
          </div>
        </section>
        <section class="equipamentos-info">
          <div class="equipamento">
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Raphael Leite</p>
            <p><strong>Email:</strong>raphael.leite@amorsaude.com</p>
            <p><strong>Cargo:</strong>Designer UI/UX</p>
            <p><strong>Departamento:</strong>Produto</p>
            <p><strong>CPF:</strong>028.739.429-83</p>
            <p><strong>Data da admissão:</strong>22.01.2024</p>
            <p><strong>Data da desligamento:</strong></p>
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong>Logitech MK270</p>
            <p class="serial"><strong>S/N:</strong>2232CE1D02A8 - 2230LZX3BEEE8</p>
            <p><strong>Patrimonio:</strong>475</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Suporte</p>
            <p><strong>Marca/Modelo:</strong>Aluminio</p>
            <p class="serial"><strong>S/N:</strong></p>
            <p><strong>Patrimonio:</strong>944</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Fone</p>
            <p><strong>Marca/Modelo:</strong>Logitech H390</p>
            <p class="serial"><strong>S/N:</strong>2329AYOOCA38</p>
            <p><strong>Patrimonio:</strong>945</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook</p>
            <p><strong>Marca/Modelo:</strong>Dell Vostro 3520</p>
            <p class="serial"><strong>S/N:</strong>3932JZ3</p>
            <p><strong>Patrimonio:</strong>476</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong></p>
            <p><strong>Marca/Modelo:</strong></p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Sem Foto.jpg" alt="Fotos de Josiane Renata dos Santos da Mat" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            ...
            <p><strong>Email:</strong>vitor.silva@amorsaude.com</p>
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Tiago Cardoso</p>
            <p><strong>Email:</strong>tiago.cardoso@amorsaude.com</p>
            <p><strong>Cargo:</strong>Tech Lead</p>
            <p><strong>Departamento:</strong>Desenvolvimento</p>
            <p><strong>CPF:</strong></p>
            <p><strong>Data da admissão:</strong></p>
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Renan Gregorato</p>
            <p><strong>Email:</strong>renan.gregorato@amorsaude.com</p>
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Raul Tonello</p>
            <p><strong>Email:</strong>raul.tonello@amorsaude.com</p>
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Raphael De Souza Pereira</p>
            <p><strong>Email:</strong>raphael.pereira@amorsaude.com</p>
            <p><strong>Cargo:</strong>Desenvolvedor Pl</p>
            <p><strong>Departamento:</strong>Desenvolvimento</p>
            <p><strong>CPF:</strong>069.081.765-76</p>
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Paloma Santana</p>
            <p><strong>Email:</strong>paloma.santana@amorsaude.com</p>
            <p><strong>Cargo:</strong>Desenvolvedor(a) Pl</p>
            <p><strong>Departamento:</strong>Desenvolvimento</p>
            <p><strong>CPF:</strong></p>
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Lucas Saconato</p>
            <p><strong>Email:</strong>lucas.saconato@amorsaude.com</p>
            <p><strong>Cargo:</strong>Consultor de Desenvolvimento</p>
            <p><strong>Departamento:</strong></p>
            <p><strong>CPF:</strong></p>
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>José Vinicius Menari</p>
            <p><strong>Email:</strong>jose.menari@amorsaude.com</p>
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook AMD Ryzen 7 5800H 16GB</p>
            <p><strong>Marca/Modelo:</strong>Nitro AN515-45</p>
            <p class="serial"><strong>S/N:</strong>NHQEYAL0053290360F9Z00</p>
            <p><strong>Patrimonio:</strong></p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Suporte</p>
            <p><strong>Marca/Modelo:</strong>Aluminio</p>
            <p class="serial"><strong>S/N:</strong></p>
            <p><strong>Patrimonio:</strong>942</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong>Logitech MK270</p>
            <p class="serial"><strong>S/N:</strong>2232CE1CFB08 - 2229LZXMWT68</p>
            <p><strong>Patrimonio:</strong>474</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Fone</p>
            <p><strong>Marca/Modelo:</strong>LogiTech H390</p>
            <p class="serial"><strong>S/N:</strong>2330AYO42778</p>
            <p><strong>Patrimonio:</strong>943</p>
          </div>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            ...
            <p><strong>Email:</strong></p>
            <p><strong>Cargo:</strong>Desenvolvedor</p>
            <p><strong>Departamento:</strong>Deselvolvimento</p>
            <p><strong>CPF:</strong>081.401.955-29</p>
            <p><strong>Data da admissão:</strong>15.09.2024</p>
            <p><strong>Data da desligamento:</strong></p>
            <p><strong>Centro de Custo:</strong>13012 - Desenvolvimento</p>
          </div>
        </section>
        <section class="equipamentos-info">
          <div class="equipamento">
            ...
            <p><strong>Marca/Modelo:</strong>Aluminio</p>
            <p class="serial"><strong>S/N:</strong></p>
            <p><strong>Patrimonio:</strong>1174</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Fone</p>
            <p><strong>Marca/Modelo:</strong>Dell HS2201</p>
            <p class="serial"><strong>S/N:</strong>vn-ormh97-lxn00-43s-050h-a01</p>
            <p><strong>Patrimonio:</strong>1173</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong>Logitech MK270</p>
            <p class="serial"><strong>S/N:</strong>2345CE4B4F8</p>
            <p><strong>Patrimonio:</strong>1526</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook Win-11 </p>
            <p><strong>Marca/Modelo:</strong>Lenovo</p>
            <p class="serial"><strong>S/N:</strong>peoc9bxc</p>
            <p><strong>Patrimonio:</strong>1194</p>
          </div>
        </section>
        <section class="ticket">
          <p><strong>ID Ticket:</strong>#81141</p>
          <p><strong>Equipamentos:</strong>Suporte, Fone, Teclado e Mouse, Notebook</p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Gustavo Alves Barreto</p>
            <p><strong>Email:</strong>gustavo.barreto@amorsaude.com</p>
            <p><strong>Cargo:</strong>Desenvolvedor Fullstack Pl</p>
            <p><strong>Departamento:</strong>Desenvolvimento</p>
            <p><strong>CPF:</strong>186.537.787-21</p>
            <p><strong>Data da admissão:</strong>21.11.2023</p>
            <p><strong>Data da desligamento:</strong></p>
            <p><strong>Centro de Custo:</strong>13012 - Desenvolvimento</p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Gabriel Dourado.jpeg" alt="Foto de Gabriel Dourado" class="foto"></div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Gabriel Dourado</p>
            <p><strong>Email:</strong>gabriel.dourado@amorsaude.com</p>
            <p><strong>Cargo:</strong>Analista De Desenvolvimento</p>
            <p><strong>Departamento:</strong>Desenvolvimento</p>
            <p><strong>CPF:</strong>N/A</p>
            <p><strong>Data de admissão:</strong>18.04.2022</p>
            <p><strong>Data de desligamento:</strong>N/A</p>
            <p><strong>Centro de Custo:</strong>13012 - Desenvolvimento</p>
          </div>
        </section>
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook Win-10 8GB Ryzen 5 5500u</p>
            <p><strong>Marca/Modelo:</strong>Thinkpad e14 gen3</p>
            <p class="serial"><strong>S/N:</strong>Pe08sjca</p>
            <p><strong>Patrimônio:</strong>158</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Fone</p>
            <p><strong>Marca/Modelo:</strong>Logitech H390</p>
            <p class="serial"><strong>S/N:</strong>2126me00k5w8</p>
            <p><strong>Patrimônio:</strong>714</p>
          </div>
        </section>
        <section class="ticket">
          <p><strong>ID Ticket:</strong>N/A</p>
          <p><strong>Equipamentos:</strong>Notebook, Fone</p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Fabio Manoel Goncalves D'Avilla.jpeg" alt="Foto de Fabio Manoel Goncalves D'Avilla" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/SEM FOTO.jpg" alt="Foto de Bianca Naomi de Carvalho" class="foto"></div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Bianca Naomi de Carvalho</p>
            <p><strong>Email:</strong>bianca.carvalho@amorsaude.com</p>
            <p><strong>Cargo:</strong>Desenvolvedor PL</p>
            <p><strong>Departamento:</strong>Desenvolvimento</p>
            <p><strong>CPF:</strong>484.757.418-43</p>
            <p><strong>Data de admissão:</strong>01.04.2024</p>
            <p><strong>Data de desligamento:</strong>N/A</p>
            <p><strong>Centro de Custo:</strong>13012 - Desenvolvimento</p>
            <p><strong>Substituição:</strong>Paulo Imon</p>
          </div>
        </section>
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook i5-1135G7 8GB</p>
            <p><strong>Marca/Modelo:</strong>Dell Vostro 15 3510</p>
            <p class="serial"><strong>S/N:</strong>N/A</p>
            <p><strong>Patrimônio:</strong>N/A</p>
          </div>
          <div class="equipamento">
            ...
            <p><strong>Marca/Modelo:</strong>Logitech H390</p>
            <p class="serial"><strong>S/N:</strong>2309ME013N79</p>
            <p><strong>Patrimônio:</strong>838</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong>Logitech MK270</p>
            <p class="serial"><strong>S/N:</strong>2243CE2583F9 - 2241LZX3PAS8</p>
            <p><strong>Patrimônio:</strong>279</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Suporte</p>
            <p><strong>Marca/Modelo:</strong>Alumínio</p>
            <p class="serial"><strong>S/N:</strong>N/A</p>
            <p><strong>Patrimônio:</strong>829</p>
          </div>
        </section>
        <section class="ticket">
          <p><strong>ID Ticket:</strong>N/A</p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Ana Beatriz Melo Silveir.jpeg" alt="Foto de Ana Beatriz Melo Silveira" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../foto_colaboradores/SEM FOTO.jpg" alt="Foto de Daniel Braz" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Lucas Ramalho.jpeg" alt="foto de Lucas Claudino de Oliveira Ramalho" class="foto"></div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Lucas Claudino de Oliveira Ramalho</p>
            <p><strong>Email:</strong>lucas.ramalho@amorsaude.com</p>
            <p><strong>Cargo:</strong>Desenvolvedor Jr</p>
            <p><strong>Departamento:</strong>Desenvolvimento</p>
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="foto_colaboradores/vinicius_massullo.jpg" alt="Foto de Vinicius Massullo Silva" class="foto" />
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Lucas Mateus.jpeg" alt="Foto de Lucas Mateus" class="foto">
          </div>
          <div class="colaborador-details">
        ...
        <section class="ticket">
          <p><strong>ID Ticket:</strong>N/A</p>
          <p><strong>Equipamentos:</strong>Monitor, Notebook, Fone, Suporte, Teclado e Mouse, Celular
            (Devolvido), Monitor (Devolvido)</p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/SEM FOTO.jpg" alt="Foto de Murilo Samuel Borba" class="foto">
          </div>
          <div class="colaborador-details">
        ...
        <section class="ticket">
          ...
          <p><strong>Equipamentos:</strong>Suporte, Teclado e Mouse, Fone, Notebook Win-10 AMD Ryzen5-500U
            24GB</p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Simone Rodrigue</p>
            <p><strong>Email:</strong>simone.rodrigues@amorsaude.com</p>
            <p><strong>Cargo:</strong>Assistente de CS</p>
            <p><strong>Departamento:</strong>Relacionamento com Profissionais da Saúde</p>
            <p><strong>CPF:</strong></p>
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
            <p><strong>Centro de Custo:</strong>12003</p>
          </div>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong> Natalia Almeida Rodrigues</p>
            <p><strong>Email:</strong> natalia.rodrigues@amorsaude.com</p>
            <p><strong>Cargo:</strong> Aprendiz Administrativo</p>
            <p><strong>Departamento:</strong> Relacionamento com Cliente</p>
            <p><strong>CPF:</strong> 161.969.126-40</p>
            <p><strong>Data de admissão:</strong> 20.05.2024</p>
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong> Fone</p>
            <p><strong>Marca/Modelo:</strong> Logitech H390</p>
            <p class="serial"><strong>S/N:</strong> 2330AY042F58</p>
            <p><strong>Patrimônio:</strong> 1442</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong> Logitech MK270</p>
            <p class="serial"><strong>S/N:</strong> 233ACE2DA828</p>
            <p><strong>Patrimônio:</strong> 996</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Notebook Win-11 i5-1235U 8GB</p>
            <p><strong>Marca/Modelo:</strong> Dell Vostro 3520</p>
            <p class="serial"><strong>S/N:</strong> D5DY014</p>
            <p><strong>Patrimônio:</strong> 1443</p>
          </div>
        </section>
        <section class="ticket">
          <p><strong>ID Ticket:</strong> #22784</p>
          <p><strong>Equipamento:</strong> Notebook, Fone, Teclado e Mouse</p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong> Eduardo Ceciliano Junior</p>
            <p><strong>Email:</strong> eduardo.junior@amorsaude.com</p>
        ...
        <section class="equipamentos-info">
          ...
          <div class="equipamento">
            ...
            <p class="serial"><strong>S/N:</strong> 2232cCE1D0278</p>
          ...
          <div>
            <p><strong>Tipo:</strong>Monitor</p>
            <p><strong>Marca/Modelo:</strong>Samsung Y4SKHX5T601532E</p>
            <p class="serial"><strong>S/N:</strong>F24T350FHL</p>
            <p><strong>Patrimônio:</strong>198</p>
          </div>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div> <img src="../foto_colaboradores" alt="" class="foto"> </div>
          <div class="colaborador-details">
            ...
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
            <p><strong>Centro de Custo:</strong> 72023</p>
          </div>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../../blblioteca de codigo/foto_colaboradores" alt="" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/SEM FOTO.jpg" alt="foto de Raissa MArtins de Lima" class="foto"></div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Raíssa Martins de Lima</p>
            <p><strong>Email:</strong>raissa.lima@amorsaude.com</p>
            <p><strong>Cargo:</strong>Assistente de Retenção</p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../img/foto_colaboradores/SEM FOTO.jpg" alt="foto de Dayane Cristina Silva dos Santos" class="foto"></div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Dayane Cristina Silva dos Santos</p>
            <p><strong>Email:</strong>dayane.santos@amorsaude.com</p>
            <p><strong>Cargo:</strong>Assistente de Retenção</p>
            <p><strong>Departamento:</strong>Relacionamento com Cliente</p>
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook Win-11 i5-1235U 8GB</p>
            <p><strong>Marca/Modelo:</strong>Lenovo V15 G3 IAP</p>
            <p class="serial"><strong>S/N:</strong>PE9014216040-82UM0007BR-PE0C2WXT</p>
            <p><strong>Patrimônio:</strong>1564</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Fone</p>
            <p><strong>Marca/Modelo:</strong>Logitech H390</p>
            <p class="serial"><strong>S/N:</strong>2412AYooNX68</p>
        ...
        <p class="center">Equipamento Danificado</p>
        <section class="equipamentos-info">
          <div class="equipamento-danificados">
            <p><strong>Tipo:</strong>Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong>Logitech MK270</p>
            <p class="serial"><strong>Teclado S/N:</strong>2320CE1626C8</p>
            <p class="serial"><strong>Mouse S/N:</strong>2240LZN1KF18</p>
            <p><strong>Mouse Patrimônio:</strong>1142</p>
            <p><strong>Teclado Patrimônio:</strong>447</p>
          </div>
        </section>
        <section class="ticket">
          <p><strong>ID Ticket:</strong>#55866</p>
          <p><strong>Equipamentos:</strong>Headset, Mouse, Notebook 8G, Suporte para notebook, Teclado</p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Juliana%20de%20Oliveira%20Silvério.jpeg" alt="Foto de Juliana de Oliveira Silvério" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Paulo%20Victor%20Borges.jpeg" alt="Sem Foto" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Andre Rigobello.jfif" alt="Foto de André Rigobello Pinto" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Maria Medieros.jfif" alt="Foto de Maria Caroline Dantas De Medeiros" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Gabriele Marin Soare.jpeg" alt="foto Gabriele Marin Soare" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Murilo%20Venturoso.jpeg" alt="foto de Murilo Venturoso" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Artur%20Mello.jpeg" alt="Foto de Artur Ferreira Morais Mello" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Ana%20Caroline%20Alves.jpeg" alt="Foto de Ana Caroline de Rezende Alves" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Lucilene%20Santos%20Matias.jpeg" alt="Sem Foto" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Kelly Soares</p>
            <p><strong>Email:</strong>kelly.soares@amorsaude.com</p>
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Felipe Giacomini</p>
            <p><strong>Email:</strong>felipe.giacomini@amorsaude.com</p>
            <p><strong>Cargo:</strong>Analista De Processos BPM</p>
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Kessya De Lima Rosolini Fraga</p>
            <p><strong>Email:</strong>kessya.fraga@amorsaude.com</p>
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../foto_colaboradores" alt="Foto de Daiene Priscila Alexandre" class="foto">
          </div>
          <div class="colaborador-details">
        ...
        <section class="equipamento-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong> Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong> Logitech MK270</p>
      ...
      <article>
        <section class="colaborador-info">
          <div> <img src="../foto_colaboradores" alt="Foto de Beatriz Olive Pinho Moreira" class="foto">
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong> Beatriz Olive Pinho Moreira</p>
            <p><strong>Email:</strong> beatriz.moreira@amorsaude.com</p>
            <p><strong>Cargo:</strong> Menor Aprendiz</p>
            <p><strong>Departamento:</strong> Pessoas E Cultura</p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/SEM FOTO.jpg" alt="Foto de Venena Spadão" class="foto">
          </div>
          <div class="colaborador-details">
            ...
            <p><strong>Subtituição:</strong>Leandro Tosta Montenegro</p>
          </div>
        </section>
        <section class="equipamentos-info">
          <div class="equipamento">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../foto_colaboradores/Daniel Vieira.jpeg" alt="Foto do Daniel Vieira">
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Daniel Morais Vieira</p>
            <p><strong>Email:</strong>daniel.vieira@amorsaude.com</p>
            <p><strong>Cargo:</strong>Chief People and Culture Officer</p>
            <p><strong>Departamento:</strong>Pessoas e Cultura</p>
            <p><strong>CPF:</strong>888.237.501-30</p>
            <p><strong>Data de Entrada:</strong>15.01.2024</p>
        ...
        <div class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Monitor</p>
            <p><strong>Patrimônio:</strong>464</p>
            <p class="serial"><strong>S/N:</strong>308AZRD8A990</p>
            <p><strong>Marca/Modelo:</strong>LG22MP410-B</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Teclado e Mouse</p>
            <p><strong>Patrimônio:</strong>466</p>
            <p class="serial"><strong>S/N:</strong>2320CE1626B8 - 2316LZX3GDV8</p>
            <p><strong>Marca/Modelo:</strong>K270 - M185</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Suporte</p>
            <p><strong>Patrimônio:</strong>930</p>
            <p class="serial"><strong>S/N:</strong></p>
            <p><strong>Marca/Modelo:</strong>Alumínio</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook Win-11 i7-1255u 16GB</p>
            <p><strong>Patrimônio:</strong>467</p>
            <p class="serial"><strong>S/N:</strong>J972JZ3</p>
            <p><strong>Marca/Modelo:</strong>Dell Vostro 3520</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Headset</p>
            <p><strong>Patrimônio:</strong>929</p>
            <p class="serial"><strong>S/N:</strong>2329GG015JA8</p>
            <p><strong>Marca/Modelo:</strong>Logitech H390</p>
          </div>
        </div>
        <section class="ticket">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Lara Alves de Souz.jpeg" alt="Foto de Lara Alves de Souza" class="foto"></div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Lara Alves de Souza</p>
            <p><strong>Email:</strong>lara.souza@amorsaude.com</p>
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook Win-11 i5-1135G7 8GB</p>
            <p><strong>Patrimônio:</strong>1431</p>
            <p class="serial"><strong>S/N:</strong>3M35K3</p>
            <p><strong>Marca/Modelo:</strong>Dell Vostro 3520</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Teclado e Mouse</p>
            <p><strong>Patrimônio:</strong>1430</p>
            <p class="serial"><strong>S/N:</strong>2232CE1D0228 - 2230DLZX3BNW8</p>
            <p><strong>Marca/Modelo:</strong>Logitech MK270</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Suporte</p>
            <p><strong>Patrimônio:</strong>951</p>
            <p class="serial"><strong>S/N:</strong></p>
            <p><strong>Marca/Modelo:</strong>Alumínio</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Celular</p>
            <p><strong>Patrimônio:</strong>1223</p>
            <p class="serial"><strong>S/N:</strong>UI5MVA2797</p>
            <p><strong>Marca/Modelo:</strong>Moto E22</p>
            <p><strong>IMEI:</strong>352800824097718 32800824097726</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Chip</p>
            <p><strong>Numero:</strong>16997855852</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Fone</p>
            <p><strong>Patrimônio:</strong>952</p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Ana Almeida.jfif" alt="Foto de Ana Clara Lourenço de Almeida" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Iara Ribeiro.jfif" alt="Foto de Iara Cristina Moraes Ribeiro" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Leticia Silva.jfif" alt="Foto de Letícia Godoy da Silva" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Ana Julia Bujardi.jfif" alt="Foto de Letícia Godoy da Silva" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Edmar de Almeida.jpeg" alt="foto de Edmar de Almeida" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="foto_colaboradores/walkiria_silva.jpg" alt="Foto de Walkiria Oliveira Silva" class="foto" />
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            ...
            <p><strong>Email:</strong>deise.leite@amorsaude.com</p>
      ...
      <article>
        <section class="colaborador-info">
          ...
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Matheus Lima</p>
            <p><strong>Email:</strong>matheus.lima@amorsaude.com</p>
            <p><strong>Cargo:</strong>Supervisor De Expansão Internacional</p>
            <p><strong>Departamento:</strong>Internacional</p>
            <p><strong>CPF:</strong></p>
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../foto_colaboradores/Heitor De Paiva Boccato.jpeg" alt="foto de Heitor De Paiva Boccato"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Guilherme Correa.jpeg" alt="Foto de Guilherme Correa" class="foto" />
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Guilherme%20Neto.jpeg" alt="foto de Guilherme Neto" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/SEM%20FOTO.jpg" alt="foto Rosemeire Aparecida Vieira Soares" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/Felipe%20Cando%20Oliveira.jpeg" alt="foto de Felipe Cando Oliveira"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Lucas Pedro Pereira.jpeg" alt="Foto de Lucas Pedro Pereira" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Murillo Zanine.jpg" alt="Foto de Murillo Zanine" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Claudia Ornela.jpg" alt="Foto de Claudia Ornela" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Lauriele Santos.jpeg" alt="Foto de Lauriele Santos" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Monica Gonçalves Soares.jpeg" alt="Foto de Monica Gonçalves Soares" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Isabella%20Santana.jpeg" alt="" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Gisele%20Brochetto.jpeg" alt="foto de Gisele Brochetto" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Eduardo%20Cheade.jpeg" alt="Foto de Eduardo Cheade" class="foto">
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong> Eduardo Cheade</p>
            <p><strong>Email:</strong> eduardo.cheade@amorsaude.com</p>
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Andr%C3%A9%20Medina.jfif" alt="" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/BEATRIZ%20CHAVES.jpg" alt="Foto de Beatriz Santo Chaves" class="foto" />
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/Emily Formagio de Souza.jpeg" alt="foto de Emily Formagio de Souza"></div>
          <div class="colaborador-details">
        ...
        <section class="ticket">
          <p><strong>ID Ticket:</strong>#39154</p>
          <p><strong>Equipamento:</strong>Headset, Mouse, Notebook 8G, Suporte para notebook, Teclado
          </p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Alexy Divino.jpeg" alt="Foto de Alexy Chiodi Divino" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Caique Picolo.jpeg" alt="Foto de Caique Picolo Dal Picolo" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/Victor Lima.jpeg" alt="Victor Lima">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/Emanuela Santos.jpeg" alt="Emanuela Santos"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/Beatriz Rezende.jpeg" alt="Beatriz Rezende"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/SEM%20FOTO.jpg" alt="foto de Iris Cristina Nietto" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article class="redflag">
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/SEM%20FOTO.jpg" alt="foto de Lais Toledo Mendes da Silva" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/SEM FOTO.jpg" alt="Foto de Arnaldo Rocha Junior"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Cinthia%20Viana.jpg" alt="Foto de Cinthia Viana" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/SEM%20FOTO.jpg" alt="foto  de Felipe Bomfim" class="foto">
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Felipe Bomfim</p>
            <p><strong>Email:</strong>felipe.bomfim@amorsaude.com</p>
            <p><strong>Cargo:</strong>Analista CS Sac JR</p>
            <p><strong>Departamento:</strong>Customer Success</p>
            <p><strong>CPF:</strong>036.612.355-67</p>
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/SEM%20FOTO.jpg" alt="foto de Emily Fernandes Lopes" class="foto">
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong> Emily Fernandes Lopes</p>
            <p><strong>Email:</strong>emily.lopes@amorsaude.com</p>
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            ...
            <p><strong>Patrimônio:</strong> 322</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong> Logitech K235</p>
          ...
          <div class="equipamento">
            ...
            <p><strong>Marca/Modelo:</strong> Aluminio</p>
            <p class="serial"><strong>S/N:</strong></p>
            <p><strong>Patrimônio:</strong> 826</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Fone</p>
            <p><strong>Marca/Modelo:</strong> Jabra HSC 016</p>
            <p class="serial"><strong>S/N:</strong> 0026533565</p>
            <p><strong>Patrimônio:</strong> 616</p>
          </div>
        </section>
        <section class="ticket">
          <p><strong>Ticket:</strong> #71163</p>
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/SEM%20FOTO.jpg" alt="foto de Mayara Hellen Silva de Godoi" class="foto">
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Mayara Hellen Silva de Godoi</p>
            <p><strong>Email:</strong>mayara.godoi@amorsaude.com</p>
            <p><strong>Cargo:</strong>Analista de Documentação JR</p>
            <p><strong>Departamento:</strong>Documentações</p>
            <p><strong>CPF:</strong>415.456.688-17</p>
        ...
        <section class="ticket">
          <p><strong>ID Ticket:</strong>#80123</p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Nicolas%20Tassinari.jpeg" alt="foto de Nicolas Tassinari " class="foto"></div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Nicolas Tassinari</p>
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Monitor</p>
            <p><strong>Marca/Modelo:</strong>LG 22Mp410-B</p>
            <p class="serial"><strong>S/N:</strong>303AZZX8K016</p>
            <p><strong>Patrimonio:</strong>395</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong>Logitech MK270</p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Karen%20Ramos.jpeg" alt="" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Isadora%20Santos.jpeg" alt="foto de Isadora Solbaro Dos Santos" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Gabriela%20Cristina.jpeg" alt="" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Nicholas%20Lopes.jpeg" alt="Foto de Nicholas Esdras Lopes" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Cauã Bacileri.jpeg" alt="Foto de Nicholas Esdras Lopes" class="foto"></div>
          <div class="colaborador-details">
        ...
        <section class="ticket">
          ...
          <p><strong>Equipamentos:</strong>Headset, Mouse, Notebook 8G, Suporte para notebook, Teclado,
            Monitor</p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Sophia Fantini.jpeg" alt="Foto Sophia Vieira Fantini" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/Ana Fumagalli.jpeg" alt="foto de Ana Luisa Rezende Machado Fumagalli"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/Fernanda Espadari.jpeg" alt="foto de Fernanda Radiguieri Espadari "></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Carlos Cunis.jpeg" alt="foto de Carlos Cunis Pereira" class="foto"></div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Carlos Cunis Pereira</p>
            <p><strong>E-mail:</strong>carlos.cunis@amorsaude.com</p>
            <p><strong>Cargo:</strong>Analista de Treinamento</p>
            <p><strong>Departamento:</strong>BackOffice</p>
            <p><strong>CPF:</strong>480.094.538-03</p>
            <p><strong>Data da admissão:</strong>05.10.2020</p>
            <p><strong>Centro de Custo:</strong>12005 - BackOffice</p>
          </div>
        </section>
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Fone</p>
            <p><strong>Marca/Modelo:</strong>Logitech H390</p>
            <p class="serial"><strong>S/N:</strong>2332ME01XKV8</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook Win-10 i7-1165g7 8GB</p>
            <p><strong>Marca/Modelo:</strong>Lenovo Inspiron3501p90f</p>
            <p class="serial"><strong>S/N:</strong>2332ME01XKV8</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Celular</p>
            <p><strong>Marca/Modelo:</strong>Galaxy A03</p>
            <p class="serial"><strong>S/N:</strong>R9XT700EYKP</p>
            <p><strong>Patrimônio:</strong>580</p>
            <p><strong>IMEI 1:</strong>354985988578245/01</p>
            <p><strong>IMEI 2:</strong>355106278578246/01</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Monitor</p>
            <p><strong>Marca/Modelo:</strong>Dell P2018HC</p>
            <p class="serial"><strong>S/N:</strong>h2x5463</p>
            <p><strong>Patrimônio:</strong>14</p>
          </div>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/Marjorie Caetano Rodrigues.jpeg" alt="foto de Marjorie Caetano Rodrigues"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/Pedro Henrique Romano Caetano.jpeg" alt="foto de Pedro Henrique Romano Caetano"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Nicolas Tassinari.jpeg" alt="foto de Nicolas Tassinari" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/Lethicia Eliane Souza Martins.jpeg" alt="foto de Lethicia Eliane Souza Martins"></div>
          <div class="colaborador-details">
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong>MK270</p>
            <p class="serial"><strong>S/N:</strong>224CE257B59<br>2241LZX1ULS8</p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Larissa Branco Ribeiro.jpeg" alt="Foto de Larissa Branco Ribeiro" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/SEM%20FOTO.jpg" alt="foto de >Larissa Nadiane Linard Amaro" class="foto">
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Larissa Nadiane Linard Amaro</p>
            <p><strong>E-mail:</strong>larissa.amaro@amorsaude.com</p>
            <p><strong>CPF:</strong>489.032.208-62</p>
            <p><strong>Cargo:</strong>Analista Administrativo Junior</p>
            <p><strong>Departamento:</strong>Administrativo Laboratório</p>
            <p><strong>Centro de Custo:</strong>42001 - Administrativo Laboratório</p>
          </div>
        </section>
        <section class="equipamentos-info">
          <div class="equipamento">
          ...
          <div class="equipamento">
            <p><strong>Tipo:</strong>Celular</p>
            <p><strong>Marca/Modelo:</strong>Moto E22</p>
            <p class="serial"><strong>S/N:</strong>ZL73234TBV</p>
            <p><strong>Patrimônio:</strong>1150</p>
            <p><strong>IMEI 1:</strong>355569152146713/12</p>
            <p><strong>IMEI 2:</strong>355569152146721/12</p>
          </div>
        </section>
        <section class="ticket">
          <p><strong>ID Ticket:</strong>58463</p>
          <p><strong>Equipamentos:</strong>Notebook, Mouse, Teclado, Headset, Suporte, Celular</p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div> <img src="../static/img/foto_colaboradores/Larissa%20Izabela%20De%20Freitas.jpeg" alt="foto de Larissa Izabela De Freitas" class="foto"> </div>
          <div class="colaborador-details">
        ...
        <section class="equipamentos-info">
          ...
          <div class="equipamento">
            <p><strong>Tipo:</strong> Suporte</p>
            <p><strong>Marca/Modelo:</strong> Alumínio</p>
            <p class="serial"><strong>S/N:</strong> [Não informado]</p>
            <p><strong>Patrimônio:</strong> 930</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Teclado e Mouse</p>
            ...
            <p><strong>Patrimônio:</strong> 1448</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Celular</p>
            <p><strong>Marca/Modelo:</strong> Moto E13</p>
            ...
            <p><strong>Patrimônio:</strong> 1217</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Monitor</p>
            <p><strong>Marca/Modelo:</strong> LG 22MP410-B</p>
            <p class="serial"><strong>S/N:</strong> 401AZQV62940</p>
            <p><strong>Patrimônio:</strong> 1465</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Fone</p>
            <p><strong>Marca/Modelo:</strong> Logitech H390</p>
            <p class="serial"><strong>S/N:</strong> 2330AY03488</p>
            <p><strong>Patrimônio:</strong> 970</p>
          </div>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div> <img src="../static/img/foto_colaboradores/Leonardo Botelho.jpeg" alt="Foto de Leonardo Cotrim Ferreira Pinto de Oliveira Botelho" class="foto" /> </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div> <img src="../static/img/foto_colaboradores/Jade Rodrigues.jpeg" alt="Foto de Jade Rodrigues" class="foto" /> </div>
          <div class="colaborador-details">
        ...
        <section class="ticket">
          ...
          <p> <strong>Equipamentos: </strong>Headset, Notebook 8G, Suporte para
            notebook, Teclado e Mouse, Celular, Monitor extra </p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div> <img src="../static/img/foto_colaboradores/Livia Paula.jpeg" alt="Foto de Livia Marcolino Paula" class="foto" /> </div>
          <div class="colaborador-details">
        ...
        <section class="equipamentos-info">
          ...
          <div class="equipamento">
            <p><strong>Tipo: </strong>Teclado e Mouse</p>
            <p><strong>Marca/Modelo: </strong>Logitech MK270</p>
            <p class="serial"><strong>S/N: </strong>2334CE2DA898</p>
            <p><strong>Patrimônio: </strong>1450</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo: </strong>Suporte</p>
            <p><strong>Marca/Modelo: </strong>Alumínio</p>
            <p class="serial"><strong>S/N: </strong></p>
            <p><strong>Patrimônio: </strong>726</p>
          </div>
        </section>
        <section class="ticket">
          <p><strong>ID Ticket: </strong></p>
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Camila%20Cardoso.jpeg" alt="" class="foto" />
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong> Camila Francisca Cardoso Dos Santos</p>
            <p><strong>Email:</strong> camila.cardoso@amorsaude.com</p>
            <p><strong>Cargo:</strong> Analista Comercial</p>
            <p><strong>Departamento:</strong> Administrativo</p>
            <p><strong>CPF:</strong> 381.965.788-65</p>
            <p><strong>Data da admissão:</strong> 03.07.2023</p>
            <p><strong>Data da desligamento:</strong></p>
            <p><strong>Centro de Custo:</strong> 32001 - Administrativo</p>
          </div>
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Emanuelly%20Dias.jpeg" alt="foto de Emanuelly Dias" class="foto" />
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Emanuelly Dias</p>
            <p><strong>Email:</strong>emanuelly.dias@amorsaude.com</p>
            <p><strong>Cargo:</strong>Analista De Operações Laboratoriais Jr</p>
            <p><strong>Departamento:</strong>Administrativo</p>
            <p><strong>CPF:</strong>439.925.968-00</p>
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
            <p><strong>Centro de Custo:</strong>42001 - Administrativo Laboratório</p>
          </div>
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Gabriela%20Louzada.jpeg" alt="" class="foto" />
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Gabriela Louzada</p>
            <p><strong>Email:</strong>gabriela.louzada@amorsaude.com</p>
            <p><strong>Cargo:</strong>Head De Exames</p>
            <p><strong>Departamento:</strong>Administrativo</p>
            <p><strong>CPF:</strong></p>
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Jaqueline Roviero.jpeg" alt="" class="foto" />
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Franciele Tavares.jpeg" alt="" class="foto" />
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Franciele Tavares</p>
            <p><strong>Email:</strong>franciele.tavares@amorsaude.com</p>
            <p><strong>Cargo:</strong>Analista De Canais Digitais E Relacionamento Sr</p>
            <p><strong>Departamento:</strong>Administrativo</p>
            <p><strong>CPF:</strong>395.805.108-14</p>
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
            <p><strong>Centro de Custo:</strong>22001 - Consulta Assistida</p>
          </div>
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook</p>
            <p><strong>Marca/Modelo:</strong>Dell Inspirion 3501</p>
            <p class="serial"><strong>S/N:</strong>p90f002</p>
            <p><strong>Patrimonio:</strong>058</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Fone</p>
            <p><strong>Marca/Modelo:</strong>Jabra HSC016</p>
            <p class="serial"><strong>S/N:</strong>00201903953</p>
            <p><strong>Patrimonio:</strong>754</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Monitor</p>
            <p><strong>Marca/Modelo:</strong>Dell E1920hf</p>
            <p class="serial"><strong>S/N:</strong>6216d83</p>
            <p><strong>Patrimonio:</strong>057</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong>MK235</p>
            <p class="serial"><strong>Teclado S/N:</strong>2206lzx6r888</p>
            <p class="serial"><strong>Mouse S/N:</strong>2210ce129659</p>
            <p><strong>Patrimonio:</strong>544/413</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Celular</p>
            <p><strong>Marca/Modelo:</strong>Samsung Galaxy A02</p>
            <p class="serial"><strong>S/N:</strong>rq8rb09sffa</p>
            <p><strong>Patrimonio:</strong>753</p>
            <p><strong>IMEI 1:</strong>350844817060665/01</p>
            <p><strong>IMEI 2:</strong>356067157060665/01</p>
          </div>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Sarah%20Andrade.jpeg" alt="foto deSarah Andrade" class="foto" />
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong> Sarah Gome Mariano de Andrade</p>
            <p><strong>Email:</strong> sarah.andrade@amorsaude.com</p>
            <p><strong>Cargo:</strong> Coordenador(a) Administrativo</p>
            <p><strong>Departamento:</strong> Administrativo</p>
            <p><strong>CPF:</strong></p>
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
            <p><strong>Centro de Custo:</strong> 42001 - Administrativo</p>
          </div>
        </section>
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong> Notebook</p>
            <p><strong>Marca/Modelo:</strong> Lenovo V15 82ME</p>
            <p class="serial"><strong>S/N:</strong> PE09EEKD</p>
            <p><strong>Patrimônio:</strong> 200</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Fone</p>
            <p><strong>Marca/Modelo:</strong> Jabra HSCO16</p>
            <p class="serial"><strong>S/N:</strong> 251009344</p>
            <p><strong>Patrimônio:</strong> 625</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Mouse</p>
            <p><strong>Marca/Modelo:</strong> [Não informado]</p>
            <p class="serial"><strong>S/N:</strong> [Não informado]</p>
          ...
          <div class="equipamento">
            <p><strong>Tipo:</strong> Smartphone</p>
            <p><strong>Marca/Modelo:</strong> Galaxy A03</p>
            <p class="serial"><strong>S/N:</strong> R9XT805QBEJ</p>
            <p><strong>IMEI 1:</strong> 350916872899862/01</p>
            <p><strong>IMEI 2:</strong> 354654232899860/01</p>
            <p><strong>Patrimônio:</strong> 623</p>
          </div>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Bruna%20Reis.jpeg" alt="" class="foto" />
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Bruna Reis</p>
            <p><strong>Email:</strong>bruna.reis@amorsaude.com</p>
            <p><strong>Cargo:</strong>Coordenador(a) Técnico</p>
            <p><strong>Departamento:</strong>Administrativo</p>
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong> Notebook</p>
            <p><strong>Marca/Modelo:</strong> Lenovo V15 82ME</p>
            <p class="serial"><strong>S/N:</strong> PE09EEMQ</p>
            <p><strong>Patrimônio:</strong> 199</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Headset</p>
            <p><strong>Marca/Modelo:</strong> Jabra HSC0016</p>
            <p class="serial"><strong>S/N:</strong> 274054614</p>
            <p><strong>Patrimônio:</strong> 603</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Mouse</p>
            <p><strong>Marca/Modelo:</strong> [Não informado]</p>
          ...
          <div class="equipamento">
            <p><strong>Tipo:</strong> Smartphone</p>
            <p><strong>Marca/Modelo:</strong> Galaxy A03</p>
            <p class="serial"><strong>S/N:</strong> R9QTA00JMDH</p>
            <p><strong>IMEI 1:</strong> 351989279313422/01</p>
            <p><strong>IMEI 2:</strong> 353297239313427/01</p>
            <p><strong>Patrimônio:</strong> 624</p>
          </div>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Amanda%20Reis.jpeg" alt="foto de Amanda da Silva Reis" class="foto" />
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Ana Rosa.jpeg" alt="Foto de Ana Celeste de Souza Rosa" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Elaine%20Oliveira.jpeg" alt="" class="foto">
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Elaine Fernandes de Oliveira</p>
            <p><strong>Email:</strong>elaine.oliveira@amorsaude.com</p>
            <p><strong>Cargo:</strong>Analista de Sac</p>
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook</p>
            <p><strong>Marca/Modelo:</strong>Ideapad3 5alc6</p>
            <p class="serial"><strong>S/N:</strong>PE09782L</p>
            <p><strong>Patrimonio:</strong>172</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Fone</p>
            <p><strong>Marca/Modelo:</strong>Jabra HSC016</p>
            <p class="serial"><strong>S/N:</strong>2100403922809</p>
            <p><strong>Patrimonio:</strong>559</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Celular</p>
            <p><strong>Marca/Modelo:</strong>Samsung A03</p>
            <p class="serial"><strong>S/N:</strong>r9qt3034sgh</p>
            <p><strong>Patrimonio:</strong>516</p>
            <p><strong>IMEI 1:</strong>351989271337122/01</p>
            <p><strong>IMEI 2:</strong>353297231337127/01</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Adaptador de Rede</p>
            <p><strong>Marca/Modelo:</strong></p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img//foto_colaboradores/ESTEFANIA BRONDI.jpeg" alt="Foto de Estefania Camilo Brondi Paes" class="foto"></div>
          <div class="colaborador-details">
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo: </strong>Suporte</p>
            <p><strong>Patrimônio: </strong>981</p>
            <p class="serial"><strong>S/N: </strong></p>
            <p><strong>Marca/Modelo: </strong>Alumínio</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo: </strong>Teclado e Mouse</p>
            <p><strong>Patrimônio</strong>1468</p>
            <p class="serial"><strong>S/N: </strong>2234CE2DA868</p>
            <p><strong>Marca/Modelo: </strong>Logitech MK270</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo: </strong>Notebook Win-11 i5-1235U 8GB</p>
            <p><strong>Patrimônio: </strong>1469</p>
            <p class="serail"><strong>S/N: </strong>H229N04</p>
            <p><strong>Marca/Modelo: </strong>Dell Vosro 3520</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo: </strong>Celular</p>
            <p><strong>Patrimônio: </strong>642</p>
            <p class="serail"><strong>S/N: </strong>R9XT90898ZY</p>
            <p><strong>Marca/Modelo: </strong>Galaxy A03s</p>
            <p><strong>IMEI 1: </strong>353541243434871</p>
            <p><strong>IMEI 2: </strong>354183763434871</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo: </strong>Headset</p>
            <p><strong>Patrimônio: </strong>988</p>
            <p class="serial"><strong>S/N: </strong>233AYAYO325CB</p>
            <p><strong>Marca/Modelo: </strong>Logitech H390</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo: </strong>Monitor</p>
            <p><strong>Patrimônio: </strong>1474</p>
            <p class="serail"><strong>S/N: </strong>401azalfc536</p>
            <p><strong>Marca/Modelo: </strong>LG22MP410-B</p>
          </div>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img//foto_colaboradores/Gabriela Fritz.jpeg" alt="Foto de Gabriela Fritz" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img//foto_colaboradores/SEM FOTO.jpg" alt="Foto de Gilmara Luiza de Oliveira" class="foto"></div>
          <div class="colaborador-details">
            <p><strong>Colaborador: </strong>Gilmara Luiza de Oliveira</p>
            <p><strong>Email: </strong>gilmara.oliveira@amorsaude.com</p>
        ...
        <section class="equipamentos-info">
          ...
          <div class="equipamento">
            ...
            <p><strong>Patrimonio: </strong>1529</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo: </strong>Celular</p>
            <p><strong>Marca/Modelo: </strong>Moto E22</p>
            <p class="serial"><strong>S/N: </strong>ZF5244C2KF</p>
            <p><strong>Patrimonio: </strong>1228</p>
            <p><strong>IMEI 1: </strong>352800824226754</p>
            <p><strong>IMEI 2: </strong>352800824226762</p>
          </div>
          <div class="equipamento">
            ...
            <p><strong>Patrimonio: </strong>1477</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo: </strong>Notebook Win-11 i5-1235U 8GB</p>
            <p><strong>Marca/Modelo: </strong>Lenovo V15 G3</p>
            <p class="serial"><strong>S/N: </strong>PEOC4E5</p>
            <p><strong>Patrimonio: </strong>1528</p>
          </div>
        </section>
        <section class="ticket">
          <p><strong>Ticket: </strong>#38038</p>
          <p><strong>Equipamentos: </strong>Fones, Notebook, Monitor, Suporte, Teclado e Mouse</p>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/JULIA SILVA.jpeg" alt="Foto de Julia Carolina da Silva" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Malinda Oliveira.jpeg" alt="Malinda Gonçalves de Oliveira" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/SEM FOTO.jpg" alt="Miria Elisiane Cardoso"></div>
          <div class="colaborador-details">
            ...
            <p><strong>CPF: </strong></p>
            <p><strong>Centro de Custo: </strong>12002 - SAC</p>
            <p><strong>Subtituição: </strong>Angelica Emanuela dos Santos Pires</p>
          </div>
        </section>
        <section class="equipamentos-info">
          <div class="equipamento">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/RUBIA ALBUQUERQUE.jpeg" alt="Foto de Rubia Camila Albuquerque Dos Santos" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/SEM FOTO.jpg" alt="Foto de Vanessa de Souza Matos" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Yago%20Oliveira.jpeg" alt="" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/William%20Paulino%20Lima.jpeg" alt="Foto de William Paulino Lima" class="foto" />
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div class="colaborador-img">
            <img src="../static/img/foto_colaboradores/Natanel%20Zavanela.jpeg" alt="Natanael Zavanela" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../img/foto_colaboradores/Junior%20Ortolan.jpeg" alt="" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Bruna Emilio.jpg" alt="Foto de Bruna Rafaela Emilio" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article class="redflag">
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Fernando%20Silva.jpeg" alt="Foto de Fernando Vinicius Silva" class="foto" />
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Claudia Dias.jpeg" alt="foto de Claudia Regina Vieria Dias" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Fabio Rafael.jpeg" alt="" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Gabriela Martins.jpeg" alt="foto de Gabriela Bouchabki Martins" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../foto_colaboradores/Eduardo Miskulin.jpeg" alt="foto de Eduardo Miskulin Jardao" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/SEM FOTO.jpg" alt="Foto de Bruno Yuri Alves De Oliveira" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/William Koller.jpeg" alt="Foto de William Cezar Koller" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Gabriel Guilherme.jpeg" alt="Foto de Gabriel Guilherme" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Sem Foto.jpg" alt="Davi Ribeiro" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Sem Foto.jpg" alt="Tiago Amado" class="foto"></div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Tiago Amado</p>
            <p><strong>Email:</strong>tiago.amado@amorsaude.com</p>
            <p><strong>Cargo:</strong>Analista de dados</p>
            <p><strong>Departamento:</strong>Dados</p>
            <p><strong>CPF:</strong>022.326.901-80</p>
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
            <p><strong>Centro de Custo:</strong></p>
            <p><strong>Termo de Entrega do Equipamento:</strong></p>
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook</p>
            <p><strong>Marca/Modelo:</strong>Dell Vostro 3400 P132G</p>
            <p class="serial"><strong>S/N:</strong>3bbtqk3</p>
            <p><strong>Patrimonio:</strong>065</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Fone</p>
            <p><strong>Marca/Modelo:</strong>Logitech H390</p>
            <p class="serial"><strong>S/N:</strong>2125me0k0568</p>
            <p><strong>Patrimonio:</strong>741</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Monitor</p>
            <p><strong>Marca/Modelo:</strong>Samsung F24T350FHL</p>
            <p class="serial"><strong>S/N:</strong>y4skhx5t300155p</p>
            <p><strong>Patrimonio:</strong>066</p>
          </div>
        </section>
      </article>
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Gabriel Carvalho.jfif" alt="Foto de Gabriel Carrasco De Carvalho" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Graziele Ambrosio.jpg" alt="foto Graziele Ambrosio " class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Jade%20Rodrigues.jpeg" alt="Foto de Daniel Morais Vieira" class="foto"></div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong>Jade Rodrigues</p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="foto_colaboradores/Amanda%20Gazetta.jpeg" alt="Foto de Amanda Gazetta" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Bruno Dias.jpeg" alt="foto de Bruno Dias" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Laura Paschoin.jpeg" alt="Foto de Laura Garcia Paschoin" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div> <img src="../foto_colaboradores" alt="Foto de Bianca Festucci Duzzi" class="foto"> </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../foto_colaboradores/Eduardo Santos.jpeg" alt="Foto de Eduardo Santos" class="foto" />
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Dione Antonio dos Santos.jpeg" alt="foto de Dione Antonio dos Santos" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../foto_colaboradores/Felipe Fernandes.jfif" alt="Foto Felipe Fernades" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../foto_colaboradores/SEM FOTO.jpg" alt="Foto de João Pedro Silvestre" class="foto" />
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../foto_colaboradores/SEM FOTO.jpg" alt="Foto de Jordy Neves" class="foto" />
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div> <img src="../static/img/foto_colaboradores/Pricila Santana.jpeg" alt="" class="foto"> </div>
          <div class="colaborador-details">
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong> Celular</p>
            <p><strong>Marca/Modelo:</strong>Samsun A03</p>
            <p class="serial"><strong>S/N:</strong> r9xt700tzmv</p>
            <p><strong>Patrimônio:</strong> 587</p>
            <p><strong>IMEI 1:</strong>35510627820160/01</p>
            <p><strong>IMEI 2:</strong>35498988720169/01</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Notebook</p>
            <p><strong>Marca/Modelo:</strong> Dell Vostro 15 3510</p>
            <p class="serial"><strong>S/N:</strong>6GQN4T3</p>
            <p><strong>Patrimônio:</strong> 288</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Fone</p>
            <p><strong>Marca/Modelo:</strong> Logitech</p>
            <p class="serial"><strong>S/N:</strong> 2909ME013N69</p>
            <p><strong>Patrimônio:</strong> 840</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong> Dell MK270</p>
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/SEM FOTO.jpg" alt="" class="foto">
          </div>
          <div class="colaborador-details">
            <p><strong>Colaborador:</strong> Victoria Carolinne Solano Novais</p>
            <p><strong>Email:</strong> victoria.novais@amorsaude.com</p>
            <p><strong>Cargo:</strong> Analista Financeiro</p>
            <p><strong>Departamento:</strong> Financeiro</p>
            <p><strong>CPF:</strong>114.741.426-21</p>
            <p><strong>Data da admissão:</strong></p>
            <p><strong>Data da desligamento:</strong></p>
            <p><strong>Centro de Custo:</strong>13001 - Financeiro</p>
          </div>
        ...
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong>Notebook</p>
            <p><strong>Marca/Modelo:</strong>Lenovo v15 82ME </p>
            <p><strong>S/N:</strong>PE09EEM1</p>
            <p><strong>Patrimônio:</strong>201</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Fone</p>
            <p><strong>Marca/Modelo:</strong>Jabra HSC016</p>
            <p><strong>S/N:</strong>274056948</p>
            <p><strong>Patrimônio:</strong>628</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Smartphone</p>
            <p><strong>Marca/Modelo:</strong>Galaxy a03</p>
            <p><strong>S/N:</strong>r9qta00gh5a</p>
            <p><strong>Patrimônio:</strong>627</p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Barbara Bidurin.jpeg" alt="Foto de Barbara Bidurin" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Gabriela Georgete.jpg" alt="Foto de Gabriela Georgete da Cruz" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Marco Bizarri.jpg" alt="Foto Marco Aurélio Bizarri" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Andreia Lopes.jpg" alt="Foto de Andreia Lopes" class="foto"></div>
          <div class="colaborador-details">
            ...
            <p><strong>Departamento:</strong>Financeiro</p>
            <p><strong>Data desligamento:</strong>30.08.2024</p>
            <p><strong>CPF:</strong>416.389.198.60</p>
            <p><strong>Centro de Custo:</strong>13001 - Financeiro</p>
          </div>
        </section>
        <section class="equipamentos-info">
          ...
          <div class="equipamento">
            ...
            <p class="serial"><strong>S/N:</strong>576564</p>
            <p><strong>Marca/Modelo:</strong>Multilaser/MO300</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong>Smartphone</p>
            ...
            <p><strong>IMEI 1:</strong>351989279313463/01</p>
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/FABRICIO FREITAS.jpeg" alt="Foto de Francisco Fabricio De Lima Freitas" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Carolina%20Lopes.jpeg" alt="foto de Carolina Antonino Lopes" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img class="foto" src="../static/img/foto_colaboradores/Helena Bugliani.jpeg" alt="Foto do Helena Silva Bugliani"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Bianca Inácio.jpeg" alt="Foto de Bianca Inacia da Silva" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Tatiane Zeotti.jpeg" alt="Foto de Tatiane Zeotti" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div> <img src="../static/img/foto_colaboradores/SEM%20FOTO.jpg" alt="Foto de Ana Laura Santos" class="foto" /> </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div> <img src="../static/img/foto_colaboradores/SEM%20FOTO.jpg" alt="foto de Ana Carolina Rossi" class="foto" /> </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Suellen%20Tavares.jpeg" alt="Foto de Suellen Aparecida Crispim Tavares" class="foto" />
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img alt="Foto de Amanda Dualattka Marcolino" src="../static/img/foto_colaboradores/Amanda%20Marcolino.jpeg" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img alt="Foto de Isadora Soares Marques" src="../static/img/foto_colaboradores/ISADORA MARQUES.jpeg" class="foto">
          </div>
          <div class="colaborador-details">
            ...
            <p><strong>Data de admissão:</strong> 18.03.2024</p>
            <p><strong>Data de desligamento:</strong> N/A</p>
            <p><strong>Centro de Custo:</strong> 12002 - SAC</p>
          </div>
        </section>
        <section class="equipamentos-info">
          <div class="equipamento">
            <p><strong>Tipo:</strong> Teclado e Mouse</p>
            <p><strong>Marca/Modelo:</strong> Logitech MK370</p>
            <p class="serial"><strong>S/N:</strong> 2234CE1821B9 - 2230LZN0ZP58</p>
            <p><strong>Patrimônio:</strong> 343 - 344</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Suporte</p>
            <p><strong>Marca/Modelo:</strong> Alumínio</p>
            <p class="serial"><strong>S/N:</strong> N/A</p>
            <p><strong>Patrimônio:</strong> 734</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Notebook</p>
            <p><strong>Marca/Modelo:</strong> Dell Vostro 15 3510</p>
            <p class="serial"><strong>S/N:</strong> 64KLOV3</p>
            <p><strong>Patrimônio:</strong> 227</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Fone</p>
            <p><strong>Marca/Modelo:</strong> Jabra HSC016</p>
            <p class="serial"><strong>S/N:</strong> 273961372</p>
            <p><strong>Patrimônio:</strong> 675</p>
          </div>
          <div class="equipamento">
            <p><strong>Tipo:</strong> Celular</p>
            <p><strong>Marca/Modelo:</strong> Galaxy A03</p>
            <p class="serial"><strong>S/N:</strong> R9XTA0ECZCW</p>
            <p><strong>Patrimônio:</strong> 671</p>
            <p><strong>IMEI 1:</strong> 350916876993414/01</p>
            <p><strong>IMEI 2:</strong> 354654236993412/01</p>
          </div>
        </section>
      </article>
      <article>
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Dariane%20Romerio.jpeg" alt="" class="foto">
          </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/Julia Colombari.jpeg" alt="Foto de Julia Colombari" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div><img src="../static/img/foto_colaboradores/SEM FOTO.jpg" alt="Foto de Katia Tatiana Tomaz Marcondes" class="foto"></div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div> <img src="../static/img/foto_colaboradores/SEM%20FOTO.jpg" alt="foto de Barbara Carvalho" class="foto"> </div>
          <div class="colaborador-details">
      ...
      <article>
        <section class="colaborador-info">
          <div>
            <img src="../static/img/foto_colaboradores/Ed%20Pasquini.jfif" alt="" class="foto">
          </div>
          <div class="colaborador-details">
    ...
    <aside>
      ...
      <p class="notok">Não temos o termo de responsabilidade da colaboradora Felipe Cando Oliveira assinado.</p>
      <p class="notok">Não temos o termo de responsabilidade da colaboradora Lauriele Santos.</p>
      <p class="notok">Não temos o termo de responsabilidade da colaboradora Gisele Brochetto assinado.</p>
      <p class="notok">Não temos o termo de responsabilidade da colaboradora Eduardo Cheade assinado.</p>
      <p class="notok">Não temos o termo de responsabilidade da colaboradora Emily Formagio de Souza assinado.
      </p>
      <p class="notok">Não temos o termo de responsabilidade assinado do suprote em posse colaboradora Beatriz
        Vaz Rezende.</p>
      <p class="notok">Não temos o termo de responsabilidade assinado do suprote em posse colaboradora Felipe
        Bomfim.</p>
      <p class="notok">Não dispomos do termo de responsabilidade assinado pela colaboradora Larissa Branco
        Ribeiro em relação ao notebook que está sob sua posse.</p>
      <p class="notok">Não dispomos do termo de responsabilidade assinado pela colaboradora Nicolas Francisco
        Eloy Tassinari em relação ao notebook, Fone e Celular que está sob sua posse.</p>
      <p class="notok">Não dispomos do termo de responsabilidade assinado pela colaboradora Marjorie Caetano
        Rodrigues em relação ao Monitor que está sob sua posse.</p>
      <p class="notok">Não dispomos do termo de responsabilidade assinado pela colaboradora Pedro Henrique
        Romano Caetano em relação ao Monitor que está sob sua posse.</p>
      <p class="notok">Não dispomos do termo de responsabilidade assinado pela colaboradora Nicolas Francisco
        Eloy Tassinari em relação ao Notebook, Fone, Celular e Monitor que está sob sua posse.</p>
      <p class="notok">Não dispomos do termo de responsabilidade assinado pela colaboradora Carlos Cunis
        Pereira em relação aos equipamentos que está sob sua posse.</p>
      <p class="notok">Não possuímos o termo de responsabilidade assinado pela colaboradora Fernanda
        Radiguieri Espadari referente ao monitor danificado e ao monitor atual</p>
      <p class="notok">Não dispomos do termo de responsabilidade assinado pela colaboradora Ana Luisa Rezende
        Machado Fumagalli em relação aos equipamentos que está sob sua posse.</p>
      <p class="notok">Criar um novo termo de responsabilidade do Monitor para Cauã Fernado Bacilieri</p>
      <p class="notok">E-mail da colaboradora Carolina Antonino Lopes não realizado processo de backup.
        Ondrive da colabora esta com mais 400GB.</p>
      <p class="notok">Dispomos do termo de responsabilidade assinado pelo colaborador Nicolas Tassinari
        referente ao kit teclado e mouse e monitor somente.</p>
      <p class="notok">Apenas dispomos do termo de responsabilidade do monitor da colaborador Karen Ramos.</p>
      <p class="notok">Não temos o termo de responsabilidade assinado pela colaboradora Elaine Fernandes de
        Oliveira.</p>
      <p class="notok">Não temos o termo de responsabilidade assinado pela colaboradora Estefania Camilo Brondi
        Paes.</p>
      <p class="notok">Não temos o termo de responsabilidade assinado pela colaboradora Gilmara Luiza de Oliveira.
      </p>
      <p class="notok">Não temos o termo de responsabilidade assinado pela colaboradora Isadora Soares Marques.
      </p>
      <p class="notok">Não temos o termo de responsabilidade assinado pela colaboradora Isadora Soares Marques.
      </p>
      <p class="notok">Não temos o termo de responsabilidade referente ao notebook patrimonio 1528 assinado pela
        colaboradora Malinda Gonçalves de Oliveira.</p>
      <p class="notok">Não temos o termo de responsabilidade assinado pela colaboradora Miria Elisiane Cardoso.
      </p>
      <p class="">O celular Galaxy A03 de patrimonio: 564 foi transferido da colaboradora Rubia Camila Albuquerque
        dos Santos para a colaboradora Gabriela Fritz o mesmo já esta com tela tricanda. </p>
      <p class="notok">Não temos o termo de responsabilidade assinado pela colaboradora Vanessa de Souza Matos.
      </p>
      <p class='notok'>
        Não temos o termo de responsabilidade da colaboradora Larissa Izabela De Freitas.
      </p>
      <p class="notok">
        Temos o termo de responsabilidade referente ao suporte e teclado e mouse da colaboradora Jaqueline
        Roviero. No entanto, não possuímos registros do notebook e de outros equipamentos alocados a ela.
      </p>
      <p class="notok">Não temos o termo de responsabilidade da colaboradora Franciele Tavares assinado.</p>
      <p class="notok">
        Não temos o termo de responsabilidade da colaboradora Sarah Gome Mariano de Andrade assinado.
      </p>
      <p class="notok">Não temos o termo de responsabilidade da colaboradora Bruna Reis assinado.</p>
      <p class="notok">
        Temos o termo de responsabilidade referente ao celular do colaboradoror William Paulino Lima. No
        entanto,
        não possuímos registros do notebook e de outros equipamentos alocados a ele
      </p>
      <p class="notok">
        Não possuimos o termo assinado da colaboradora Larissa Nadiane Linard Amaro
      </p>
      <p class="notok">Não temos o termo de responsabilidade da colaboradora Emily Fernandes Lopes assinado
      </p>
    </aside>
