...
<body>
	...
	<main>
		<!-- Seção: WorkPack-->
		<div class="container">
			<header class="workpack" id="workpack">
				<h1>WorkPack</h1>
			</header>
			<article>
			...
			<article>
				<section class="colaborador-info">
					<div class="colaborador-details">
						...
						<p><strong>Colaborador:</strong>Lucas Nicolau Saconato</p>
						<p><strong>Email:</strong>lucas.saconato@amorsaude.com</p>
						<p><strong>Cargo:</strong>Agile Coach</p>
						<p><strong>Departamento:</strong>Desenvolvimentolucas.saconato@amorsaude.com</p>
				...
				<section class="ticket">
					<p><strong>ID Ticket:</strong>#109761</p>
			...
			<article>
				<section class="colaborador-info">
					<div class="colaborador-details">
						...
						<p><strong>Colaborador:</strong> Helvert Dias da Silveira Malaquias</p>
						<p><strong>Email:</strong>helvert.malaquias@amorsaude.com</p>
				...
				<section class="equipamentos-info">
					<div class="equipamento">
						<p><strong>Tipo:</strong> Notebook</p>
						<p><strong>Marca/Modelo:</strong> Lenovo V15 G3 IAP</p>
						<p class="serial"><strong>S/N:</strong> PE0CMYN5</p>
						<p><strong>Patrimônio:</strong> 1949</p>
					</div>
					<div class="equipamento">
						<p><strong>Tipo:</strong> Fone</p>
						<p><strong>Marca/Modelo:</strong> Dell HS2201</p>
						<p class="serial"><strong>S/N:</strong> VN-ORMH97-LXN00-43S-05XD-A01</p>
				...
				<section class="ticket">
					<p><strong>ID Ticket:</strong> #87547</p>
					<p><strong>Equipamentos:</strong> Headset, Notebook 8GB, Suporte para notebook, Teclado e Mouse,
						Celular</p>
				</section>
			</article>
			<article>
			...
			<article>
				<section class="colaborador-info">
					<div class="colaborador-details">
						<p><strong>ID Caixa:</strong>132</p>
						<p><strong>Colaborador:</strong>João Vitor Silva Alves</p>
						<p><strong>Email:</strong></p>
				...
				<section class="equipamentos-info">
					<div class="equipamento">
						...
						<p><strong>Marca/Modelo:</strong>Dell KB3121WT</p>
						<p class="serial"><strong>S/N:</strong></p>
						<p><strong>Patrimonio:</strong>1947</p>
					</div>
					<div class="equipamento">
						<p><strong>Tipo:</strong>Fone</p>
						<p><strong>Marca/Modelo:</strong>Dell WH1022</p>
						<p class="serial"><strong>S/N:</strong>397184635490</p>
						<p><strong>Patrimonio:</strong>1169</p>
					</div>
					<div class="equipamento">
						<p><strong>Tipo:</strong>Notebook</p>
						<p><strong>Marca/Modelo:</strong>Lenovo V15 G3 IAP</p>
						<p class="serial"><strong>S/N:</strong>PE0CMYLW</p>
						<p><strong>Patrimonio:</strong>1952</p>
					</div>
				</section>
				<section class="ticket">
					<p><strong>ID Ticket:</strong>#85872</p>
					<p><strong>Equipamentos:</strong>Notebook, Teclado e Mouse, Fone</p>
				</section>
			</article>
			<article>
				<section class="colaborador-info">
					<div class="colaborador-details">
						<p><strong>ID Caixa: </strong>134</p>
						<p><strong>Colaborador:</strong>Priscila Batista De Souza</p>
						<p><strong>Email:</strong>priscila.souza@amorsaude.com </p>
						<p><strong>Cargo:</strong> Assistente de CS</p>
						<p><strong>Departamento:</strong> Atendimento ao Cliente</p>
						<p><strong>CPF:</strong>333.873.878-14</p>
						<p><strong>Data de admissão:</strong>04.11.2024 </p>
						<p><strong>Data de desligamento:</strong></p>
						<p><strong>Centro de Custo:</strong> 12002 - SAC</p>
			...
			<article>
				<section class="colaborador-info">
					<div class="colaborador-details">
						...
						<p><strong>Data da desligamento:</strong></p>
						<p><strong>Centro de Custo:</strong>12007 - Regional 2</p>
						<p><strong>Subtituição:</strong>Fernando Vinicius Silva</p>
					</div>
				</section>
				<section class="equipamentos-info">
					<div class="equipamento">
			...
			<article>
				<section class="colaborador-info">
					<div class="colaborador-details">
						<p><strong>ID Caixa:</strong>138</p>
						<p><strong>Colaborador:</strong></p>
						<p><strong>Email:</strong></p>
						<p><strong>Cargo:</strong>Analista De Processos E Documentações</p>
						<p><strong>Departamento:</strong>BackOffice</p>
						<p><strong>CPF:</strong></p>
						<p><strong>Data da admissão:</strong></p>
						<p><strong>Data Promoção:</strong>04.11.2024</p>
						<p><strong>Data da desligamento:</strong></p>
						<p><strong>Centro de Custo:</strong>12005 - Backoffice</p>
						<p><strong>Subtituição:</strong>Marjorie Caetano Rodrigues</p>
					</div>
				</section>
				<section class="equipamentos-info">
					<div class="equipamento">
			...
			<article>
				...
				<section class="equipamentos-info">
					<div class="equipamento">
						<p><strong>Tipo:</strong>Notebook</p>
						<p><strong>Marca/Modelo:</strong>Lenovo G3 IAP</p>
						<p class="serial"><strong>S/N:</strong>PE0CMYL3</p>
						<p><strong>Patrimonio:</strong>1957</p>
					</div>
					<div class="equipamento">
						<p><strong>Tipo:</strong>Fone</p>
						<p><strong>Marca/Modelo:</strong>Dell HS2201</p>
						<p class="serial"><strong>S/N:</strong>VN-0rmh97-lxn00-43s-05tn-a01</p>
						<p><strong>Patrimonio:</strong>1247</p>
					</div>
					<div class="equipamento">
						<p><strong>Tipo:</strong>Teclado e Mouse</p>
						<p><strong>Marca/Modelo:</strong>Dell KB3121WT</p>
						<p class="serial"><strong>S/N:</strong>cn-oncrcc-lo300-34c-k1gz-a01</p>
						<p><strong>Teclado Patrimonio:</strong>1953</p>
						<p><strong>Mouse Patrimonio:</strong>856</p>
					</div>
				</section>
				<section class="ticket">
					<p><strong>ID Ticket:</strong></p>
					<p><strong>Equipamentos:</strong>Notebook, Suporte, Teclado e Mouse, Chip</p>
				</section>
			</article>
			<article>
				<section class="colaborador-info">
			...
			<article>
				<section class="colaborador-info">
					<div class="colaborador-details">
						<p><strong>ID Caixa: </strong>18604</p>
			...
			<article>
				...
				<section class="ticket">
					<p><strong>ID Ticket:</strong>#30511</p>
					<p><strong>Equipamentos:</strong>Notebook Win-11 i5-1235U 8GB, Teclado e Mouse, Suporte, Headset
					</p>
				</section>
			</article>
			<article>
			...
			<article>
				...
				<section class="ticket">
					...
					<p><strong>Equipamentos:</strong>Fone, Teclado e Mouse, Suporte, Carregador Motorola, Fonte,
						Notebook Win-11 i5-1235U 8GB, Smatphone</p>
				</section>
			</article>
		...
		<!-- Seção: Monitores -->
		<header class="title-monitor" id="monitor">
			<h1>Monitor</h1>
		</header>
		<div class="monitor-info">
			...
			<section class="monitor">
				...
				<div>
					<p><strong>ID Caixa:</strong>05</p>
					<p><strong>Centro Custo:</strong></p>
					<p><strong>Marca/Modelo:</strong></p>
					<p class="serial"><strong>S/N:</strong></p>
					<p><strong>Patrimonio:</strong></p>
				</div>
			...
			<section class="monitor">
				...
				<div>
					<p><strong>ID Caixa:</strong>06</p>
					<p><strong>Centro Custo:</strong>12006 - Regional 1</p>
					<p><strong>Marca/Modelo:</strong>LG 22MP410-B</p>
					<p class="serial"><strong>S/N:</strong>403AZBZ6H853</p>
					<p><strong>Patrimonio:</strong>1480</p>
					<p><strong>ID Ticket:</strong>94067</p>
				</div>
			</section>
			<section class="monitor">
				<div class="img">
				...
				<div>
					<p><strong>ID Caixa:</strong>07</p>
					<p><strong>Centro Custo:</strong>Sem Centro de Custo</p>
					<p><strong>Marca/Modelo:</strong>Dell P2018HC</p>
					<p class="serial"><strong>S/N:</strong>BR-00CPG1-TVB00-9CA-11EU-A08</p>
					<p><strong>Patrimonio:</strong>002</p>
				</div>
			</section>
			<section class="monitor">
				<div class="img">
...
-->
			...
			<section class="monitor">
				...
				<div>
					...
					<p><strong>Centro de Custo:</strong>Sem Custo</p>
					<p><strong>Marca/Modelo:</strong>LG 22MP410-B</p>
			...
			<section class=" monitor reflag">
				...
				<div>
					<p><strong>Tipo:</strong>Monitor</p>
					<p><strong>Marca/Modelo:</strong>LG 22MP410-B</p>
					<p class="serial"><strong>S/N:</strong>304azqv6r708</p>
...
-->
		...
		<div class="estoque-container">
			<!-- Sub-Seção: Máquinas de Backup -->
			<div class="maquina-backup" id="backup">
				<header class="title-maquinas">
					<h1>MAQUINA BACKUP</h1>
				</header>
				<article>
				...
				<article>
					<section class="notebooks-info">
						...
						<div class="equipamento-details">
							<p><strong>Centro de Custo:</strong>13012 - Desenvolvimento</p>
							<p><strong>Tipo:</strong>Notebook Win-11 i5-1135G7 24GB</p>
							<p><strong>Patrimonio:</strong>465</p>
							<p><strong>Marca/Modelo:</strong>Dell Latitude 3420</p>
							<p class="serial"><strong>S/N:</strong>FTZHNY3</p>
						</div>
					</section>
				</article>
				<article>
				...
				<article>
					<section class="notebooks-info">
						...
						<div class="equipamento-details">
							...
							<p><strong>Marca/Modelo:</strong>Dell Vostro P112F</p>
				...
				<article>
					<section class="notebooks-info">
						...
						<div class="equipamento-details">
							<p><strong>Centro de Custo:</strong>12010 - NGD</p>
							<p><strong>Tipo:</strong>Notebook Win-11 i5-1135G7 8GB</p>
							<p><strong>Patrimonio:</strong>247</p>
							<p><strong>Marca/Modelo:</strong>Dell Vostro 15 3510</p>
							<p class="serial"><strong>S/N:</strong>C4FQXW3</p>
						</div>
					</section>
				</article>
				<article>
					<section class="notebooks-info">
						...
						<div class="equipamento-details">
							<p><strong>Centro de Custo:</strong>12006 - Regional 1</p>
							<p><strong>Tipo:</strong>Notebook Win-11 i5-1135G7</p>
							<p><strong>Patrimonio:</strong></p>
							<p><strong>Marca/Modelo:</strong>Dell Vostro 15 3510</p>
							<p class="serial"><strong>S/N:</strong>46FQWX3</p>
							<p><strong>Alocado:</strong>Eduardo</p>
						</div>
					</section>
				</article>
			</div>
...
<body>
  ...
  <main>
    <div class="estoque-container">
      <div class="maquina-backup">
        <header class="desativados">
          <h1>MAQUINA BACKUP</h1>
        </header>
        <article>
          <section class=" notebooks-info">
            <div class="img"><img src="../assents/logo/laptop2.png" alt="icone laptop"></div>
            <div class="equipamento-details">
              <p><strong>Centro de Custo:</strong>12010 - NGD</p>
              <p><strong>Tipo:</strong>Notebook Win-11 I5-1135G7 8GB</p>
              <p><strong>Patrimonio:</strong>223</p>
      ...
      <div class="maquina-reserva">
        <header class="desativados">
          <h1>MAQUINA RESERVA</h1>
        </header>
        <article class="in-stock">
          <section class="notebooks-info">
            <div class="img"><img src="../assents/logo/laptop.png" alt="icone laptop"></div>
            <div class="equipamento-details">
              <p><strong>Nome:</strong>Reserva-01</p>
              <p><strong>Tipo:</strong>Notebook Win-10 i5-7200 8GB</p>
              <p><strong>Patrimonio:</strong>36</p>
    ...
    <div class="monitor-info">
      ...
      <article class="equipamento-danificados">
        <p><strong>Tipo:</strong>Monitor</p>
        <p><strong>Marca/Modelo:</strong>LG 22MP410-B</p>
        <p class="serial"><strong>S/N:</strong>304azqv6r708</p>
        <p><strong>Patrimonio:</strong>425</p>
